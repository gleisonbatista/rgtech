...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_old_pswd_line" id="hidden_field_data_old_pswd" style="<?php echo $sStyleHidden_old_pswd; ?>"> <span class="scFormLabelOddFormat css_old_pswd_label" style=""><span id="id_label_old_pswd"><?php echo $this->nm_new_label['old_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['old_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['old_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", "Confirmar Alteração", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-1", "", "");?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['dashboard_info']['maximized']))
  {
?>
</td></tr> 
