...
//
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil']          = "conn_hackaton";
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_cache']  = "";
   ...
   //check cache
   if(empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
...
// 
      ...
      $this->path_cache      = $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_cache'];
      ...
      if (isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['app_change_pswd']['actual_lang']) || $_SESSION['scriptcase']['app_change_pswd']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['app_change_pswd']['actual_lang'] = $this->str_lang;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['redir']['action']  = $nm_apl_dest;
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir'])) {
...
';
          ...
          if ($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']);
      ...
      {
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['redir']['action']  = "./";
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['redir']['target']  = "_self";
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          app_change_pswd_pack_ajax_response();
          exit;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir']))
      {
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_change_pswd"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_change_pswd"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hackaton', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hackaton', 1, $this->force_db_utf8);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['SC_sep_date1'];
           }
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir']))
    {
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
...
//
    ...
    function ajax_app_change_pswd_submit_form($old_pswd, $pswd, $confirm_pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_change_pswd;
        //register_shutdown_function("app_change_pswd_pack_ajax_response");
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_flag          = true;
...
//-----
      {
         ...
         if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['varList']) && !empty($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['varList']))
         {
            app_change_pswd_pack_var_list($aResp);
         }
         ...
         if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['buttonDisplayVert']))
         {
            app_change_pswd_pack_ajax_button_display_vert($aResp);
         }
         ...
         if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['event_field']) && '' != $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['event_field'];
         }
         else
         {
   ...
   function app_change_pswd_pack_ajax_set_fields(&$aResp)
   {
      ...
      foreach ($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['fldList'] as $sField => $aData)
      {
         ...
         {
            $aField['docReadonly'] = app_change_pswd_pack_protect_string($aData['docReadonly']);
         }
   ...
   function app_change_pswd_pack_var_list(&$aResp)
   {
      global $inicial_app_change_pswd;
      foreach ($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // app_change_pswd_pack_var_list
   ...
   {
      global $inicial_app_change_pswd;
      $aResp['ajaxAlert'] = array('message' => $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['params']);
   ...
   function app_change_pswd_pack_ajax_message(&$aResp)
   {
      ...
      $aResp['ajaxMessage'] = array('message'      => app_change_pswd_pack_protect_string($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['message']),
                                    ...
                                    'toast'        => isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['type']         : '',
   ...
   function app_change_pswd_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_app_change_pswd;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
