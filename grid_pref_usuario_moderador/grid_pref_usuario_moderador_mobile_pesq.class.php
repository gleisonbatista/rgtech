...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data_insert";$Nm_datas[] = "data_insert";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_cond" name="nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome'), this, 'nome')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cpf_cnpj_cond" name="cpf_cnpj_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpf_cnpj'), this, 'cpf_cnpj')">
      ...
      <br><span id="id_hide_cpf_cnpj"  <?php echo $str_hide_cpf_cnpj?>><?php
      if ($cpf_cnpj != "")
      {
      $cpf_cnpj_look = substr($this->Db->qstr($cpf_cnpj), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rg_cond" name="rg_cond" onChange="nm_campos_between(document.getElementById('id_vis_rg'), this, 'rg')">
      ...
      <br><span id="id_hide_rg"  <?php echo $str_hide_rg?>><?php
      if ($rg != "")
      {
      $rg_look = substr($this->Db->qstr($rg), 1, -1); 
      $nmgp_def_dados = array(); 
