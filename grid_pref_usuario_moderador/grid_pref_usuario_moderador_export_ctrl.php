<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pref_usuario_moderador']['sc_process_barr'] = true;
require_once('../grid_pref_usuario_moderador/index.php');
unset($_SESSION['scriptcase']['grid_pref_usuario_moderador']['sc_process_barr']);
$ExportCtrl = new grid_pref_usuario_moderador_export_control;
$ExportCtrl->Export_barr();

class grid_pref_usuario_moderador_export_control
{
