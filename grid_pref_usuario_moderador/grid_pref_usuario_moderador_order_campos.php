...
<?php
   ...
   $Ord_Cmp = new grid_pref_usuario_moderador_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pref_usuario_moderador_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["nome"] : "" . $this->Nm_lang['lang_pref_usuario_fld_nome'] . "";
   $tab_ger_campos['cpf_cnpj'] = "on";
   $tab_def_campos['cpf_cnpj'] = "cpf_cnpj";
   $tab_labels["cpf_cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["cpf_cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["cpf_cnpj"] : "CPF";
   $tab_ger_campos['rg'] = "on";
   $tab_def_campos['rg'] = "rg";
   $tab_labels["rg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["rg"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["rg"] : "" . $this->Nm_lang['lang_pref_usuario_fld_rg'] . "";
   $tab_ger_campos['orgao_emissor'] = "on";
   $tab_def_campos['orgao_emissor'] = "orgao_emissor";
   $tab_labels["orgao_emissor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["orgao_emissor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["orgao_emissor"] : "" . $this->Nm_lang['lang_pref_usuario_fld_orgao_emissor'] . "";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "telefone";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["telefone"] : "" . $this->Nm_lang['lang_pref_usuario_fld_telefone'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['labels']["email"] : "" . $this->Nm_lang['lang_pref_usuario_fld_email'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pref_usuario_moderador_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pref_usuario_moderador']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
