...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Hackaton_____grid_pref_usuario_moderador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Hackaton_____grid_pref_usuario_moderador"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pref_add_moderador'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_pref_usuario_moderador</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pref_usuario_moderador']['embutida_filho'] as $ind => $sc_init)
          {
