...
else
{
    ...
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ativo_label" id="hidden_field_label_ativo" style="<?php echo $sStyleHidden_ativo; ?>"><span id="id_label_ativo"><?php echo $this->nm_new_label['ativo']; ?></span></TD>
    <TD class="scFormDataOdd css_ativo_line" id="hidden_field_data_ativo" style="<?php echo $sStyleHidden_ativo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ativo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_ativo'][] = 'Y'; ?>
