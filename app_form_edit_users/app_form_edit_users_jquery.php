...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_senha' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_senha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_app_form_edit_users_senha_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_app_form_edit_users_senha_onfocus(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_nome_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_app_form_edit_users_nome_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_app_form_edit_users_nome_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_ativo' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_ativo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_app_form_edit_users_ativo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_app_form_edit_users_ativo_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_ativacao' + iSeqRow).bind('change', function() { sc_app_form_edit_users_codigo_ativacao_onchange(this, iSeqRow) });
...
function sc_app_form_edit_users_senha_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_senha();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_senha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_senha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_nome_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_nome();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_nome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_nome_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_app_form_edit_users_ativo_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_ativo();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_ativo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_ativo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_codigo_ativacao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
