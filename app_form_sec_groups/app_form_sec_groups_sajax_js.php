  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_form_sec_groups" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_app_form_sec_groups_form();
	}
  ...
  // ---------- Validate descricao_
  function do_ajax_app_form_sec_groups_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_validate_descricao__cb);
  } // do_ajax_app_form_sec_groups_validate_descricao_

  function do_ajax_app_form_sec_groups_validate_descricao__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_validate_descricao__cb

  // ---------- Validate sigla_
  function do_ajax_app_form_sec_groups_validate_sigla_(iNumLinha)
  {
    var nomeCampo_sigla_ = "sigla_" + iNumLinha;
    var var_sigla_ = scAjaxGetFieldText(nomeCampo_sigla_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_validate_sigla_(var_sigla_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_validate_sigla__cb);
  } // do_ajax_app_form_sec_groups_validate_sigla_

  function do_ajax_app_form_sec_groups_validate_sigla__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sigla_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sigla_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sigla_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sigla_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_validate_sigla__cb

  // ---------- Validate grupo_id_
  function do_ajax_app_form_sec_groups_validate_grupo_id_(iNumLinha)
  {
    var nomeCampo_grupo_id_ = "grupo_id_" + iNumLinha;
    var var_grupo_id_ = scAjaxGetFieldHidden(nomeCampo_grupo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_validate_grupo_id_(var_grupo_id_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_validate_grupo_id__cb);
  } // do_ajax_app_form_sec_groups_validate_grupo_id_

  function do_ajax_app_form_sec_groups_validate_grupo_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "grupo_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "grupo_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "grupo_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "grupo_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_validate_grupo_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_app_form_sec_groups_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_app_form_sec_groups_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_sec_groups_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_app_form_sec_groups_add_new_line_cb);
  } // do_ajax_app_form_sec_groups_add_new_line

  function do_ajax_app_form_sec_groups_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_app_form_sec_groups_add_new_line_cb

  // ---------- backup_line
  function do_ajax_app_form_sec_groups_backup_line(iNumLinha)
  {
    var var_grupo_id_ = scAjaxGetFieldHidden("grupo_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_backup_line(var_grupo_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_app_form_sec_groups_backup_line_cb);
  } // do_ajax_app_form_sec_groups_backup_line

  function do_ajax_app_form_sec_groups_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_app_form_sec_groups_backup_line_cb

  function do_ajax_app_form_sec_groups_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_app_form_sec_groups_cancel_insert

  function do_ajax_app_form_sec_groups_cancel_update(iSeqVert)
  {
    do_ajax_app_form_sec_groups_backup_line(iSeqVert);
...
?>
  } // do_ajax_app_form_sec_groups_cancel_update

  function do_ajax_app_form_sec_groups_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_app_form_sec_groups_restore_buttons

  // ---------- table_refresh
  function do_ajax_app_form_sec_groups_table_refresh()
  {
    var var_grupo_id_ = document.F2.grupo_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_table_refresh(var_grupo_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_groups_table_refresh_cb);
  } //  do_ajax_app_form_sec_groups_table_refresh

  function do_ajax_app_form_sec_groups_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.grupo_id_.value = scAjaxGetKeyValue("grupo_id_");
    ...
    scAjaxAlert(do_ajax_app_form_sec_groups_table_refresh_cb_after_alert);
  } // do_ajax_app_form_sec_groups_table_refresh_cb
  function do_ajax_app_form_sec_groups_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_app_form_sec_groups_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_app_form_sec_groups_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_app_form_sec_groups_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_sigla_ = scAjaxGetFieldText("sigla_" + iNumLinha);
    var var_grupo_id_ = scAjaxGetFieldHidden("grupo_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_app_form_sec_groups_submit_form(var_descricao_, var_sigla_, var_grupo_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_groups_submit_form_cb);
  } // do_ajax_app_form_sec_groups_submit_form

  function do_ajax_app_form_sec_groups_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("sigla_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("grupo_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app_form_sec_groups_submit_form_cb_after_alert);
  } // do_ajax_app_form_sec_groups_submit_form_cb
  function do_ajax_app_form_sec_groups_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_form_sec_groups_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_form_sec_groups_navigate_form()
  {
    perform_ajax_app_form_sec_groups_navigate_form();
  }

  function perform_ajax_app_form_sec_groups_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_app_form_sec_groups_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("sigla_" + iNavForm);
      scAjaxHideErrorDisplay("grupo_id_" + iNavForm);
    }
    var var_grupo_id_ = document.F2.grupo_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_navigate_form(var_grupo_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_groups_navigate_form_cb);
  } // do_ajax_app_form_sec_groups_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_form_sec_groups_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.grupo_id_.value = scAjaxGetKeyValue("grupo_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_form_sec_groups_navigate_form_cb_after_alert);
  } // do_ajax_app_form_sec_groups_navigate_form_cb
  function do_ajax_app_form_sec_groups_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_app_form_sec_groups_navigate_form_cb_after_alert
  function sc_hide_app_form_sec_groups_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sigla_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "grupo_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["descricao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sigla_" + iNumLinha] = {"label": "Sigla<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["grupo_id_" + iNumLinha] = {"label": "Group Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["descricao_"][iNumLinha] = "descricao_" + iNumLinha;
    ajax_field_mult["sigla_"][iNumLinha] = "sigla_" + iNumLinha;
    ajax_field_mult["grupo_id_"][iNumLinha] = "grupo_id_" + iNumLinha;
    ajax_field_id["descricao_" + iNumLinha] = new Array("hidden_field_label_descricao_", "hidden_field_data_descricao_" + iNumLinha);
    ajax_field_id["sigla_" + iNumLinha] = new Array("hidden_field_label_sigla_", "hidden_field_data_sigla_" + iNumLinha);
    ajax_error_count["descricao_" + iNumLinha] = "off";
    ajax_error_count["sigla_" + iNumLinha] = "off";
    ajax_error_count["grupo_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["descricao_" + iNumLinha] = "off";
    ajax_read_only["sigla_" + iNumLinha] = "off";
    ajax_read_only["grupo_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["sigla_" + iNumLinha] = "on";
    ajax_read_only["grupo_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["sigla_" + iNumLinha] = null;
    ajax_error_list["grupo_id_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["sigla_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sigla_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sigla_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sigla_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sigla_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["grupo_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["grupo_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["grupo_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["grupo_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["grupo_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sigla_'])) ? $this->nmgp_cmp_readonly['sigla_'] : 'off';
?>
    scAjaxFieldRead("sigla_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['grupo_id_'])) ? $this->nmgp_cmp_readonly['grupo_id_'] : 'on';
?>
    scAjaxFieldRead("grupo_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("descricao_" + iSeq, "on");
    scAjaxFieldRead("sigla_" + iSeq, "on");
    scAjaxFieldRead("grupo_id_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["sigla_" + iRow] || "on" == ajax_error_count["grupo_id_" + iRow]))
    {
      ...
      $("#hidden_field_data_sigla_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_grupo_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["sigla_" + iRow] && "off" == ajax_error_count["grupo_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["sigla_" + iRow] = "off";
        ajax_error_count["grupo_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_sigla_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_grupo_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
