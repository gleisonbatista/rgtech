...
$_SESSION['scriptcase']['dashboard']['glo_nm_perfil']          = "conn_hackaton";
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hackaton.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hackaton.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_Hackaton'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Hackaton'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hackaton', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hackaton', 1, $this->force_db_utf8);
    }
    else {
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Total de usuários" /></a>
                            <h3 class="scContainerTitle">Total de usuários</h3>
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('1');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Total de Denúncias" /></a>
                            <h3 class="scContainerTitle">Total de Denúncias</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="0" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('2');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Denúncias Resolvidas" /></a>
                            <h3 class="scContainerTitle">Denúncias Resolvidas</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget4' style="height: 100%" id="id-div-iframe-2"><?php echo $this->getIndexContent_widget4(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="4" data-gs-width="4" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('3');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Empresas cadastradas" /></a>
                            <h3 class="scContainerTitle">Empresas cadastradas</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="4" data-gs-width="5" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-4">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('4');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Total Pagp" /></a>
                            <h3 class="scContainerTitle">Total Pagp</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
...
<?php
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT COUNT(`id`), MONTH(`data_insert`) FROM pref_usuario WHERE (`tipo_perfil` = 'USR') AND (`tipo_cadastro` = 'PF') GROUP BY 2 ORDER BY MONTH(`data_insert`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`id`), strftime('%m', `data_insert`) FROM pref_usuario WHERE (`tipo_perfil` = 'USR') AND (`tipo_cadastro` = 'PF') GROUP BY 2 ORDER BY strftime('%m', `data_insert`) DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(id), MM(data_insert) FROM pref_usuario WHERE (tipo_perfil = 'USR') AND (tipo_cadastro = 'PF') GROUP BY 2 ORDER BY MM(data_insert) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2"><img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_pie_pie_2d.png" /><br /><b>Total de usuários</b></span></div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget3"><img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_pie_donut_2d.png" /><br /><b>Total de Denúncias</b></span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`id`), MONTH(`data_resolucao`) FROM aravisa_registro WHERE (`status` = 'R') GROUP BY 2 ORDER BY MONTH(`data_resolucao`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`id`), strftime('%m', `data_resolucao`) FROM aravisa_registro WHERE (`status` = 'R') GROUP BY 2 ORDER BY strftime('%m', `data_resolucao`) DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(id), MM(data_resolucao) FROM aravisa_registro WHERE (status = 'R') GROUP BY 2 ORDER BY MM(data_resolucao) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget4"><img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_other_gauge.png" /><br /><b>Denúncias Resolvidas</b></span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget5() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`id`), MONTH(`data_insert`) FROM pref_usuario WHERE (`tipo_cadastro` = 'PJ') GROUP BY 2 ORDER BY MONTH(`data_insert`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`id`), strftime('%m', `data_insert`) FROM pref_usuario WHERE (`tipo_cadastro` = 'PJ') GROUP BY 2 ORDER BY strftime('%m', `data_insert`) DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(id), MM(data_insert) FROM pref_usuario WHERE (tipo_cadastro = 'PJ') GROUP BY 2 ORDER BY MM(data_insert) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget5"><img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_pie_pie_3d.png" /><br /><b>Empresas Cadastradas</b></span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget6() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`saldo`), MONTH(`data_insert`) FROM aracash_credito_cidadao GROUP BY 2 ORDER BY MONTH(`data_insert`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`saldo`), strftime('%m', `data_insert`) FROM aracash_credito_cidadao GROUP BY 2 ORDER BY strftime('%m', `data_insert`) DESC";
        }
        else 
        {
            $sSql = "SELECT SUM(saldo), MM(data_insert) FROM aracash_credito_cidadao GROUP BY 2 ORDER BY MM(data_insert) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget6"><img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_pie_donut_3d.png" /><br /><b>Total de Benefícios Pagos</b></span></div>
