...
<html>
    <head>
        ...
        <title>AraGestor - Central Única de Informações</title>
        ...
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_Lemon/Sc9_Lemon_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["app_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
    ...
    <style>
    <?php
    if(isset($app_menu_menuData["data"]) && is_array($app_menu_menuData["data"]) && !empty($app_menu_menuData["data"]))
    {
        foreach($app_menu_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($app_menu_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
