  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aravisa_tipo_registro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aravisa_tipo_registro_form();
	}
  ...
  // ---------- Validate id_
  function do_ajax_form_aravisa_tipo_registro_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_aravisa_tipo_registro_validate_id__cb);
  } // do_ajax_form_aravisa_tipo_registro_validate_id_

  function do_ajax_form_aravisa_tipo_registro_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_tipo_registro_validate_id__cb

  // ---------- Validate status_
  function do_ajax_form_aravisa_tipo_registro_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldCheckbox(nomeCampo_status_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_aravisa_tipo_registro_validate_status__cb);
  } // do_ajax_form_aravisa_tipo_registro_validate_status_

  function do_ajax_form_aravisa_tipo_registro_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_tipo_registro_validate_status__cb

  // ---------- Validate descricao_
  function do_ajax_form_aravisa_tipo_registro_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_form_aravisa_tipo_registro_validate_descricao__cb);
  } // do_ajax_form_aravisa_tipo_registro_validate_descricao_

  function do_ajax_form_aravisa_tipo_registro_validate_descricao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descricao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descricao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descricao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descricao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_tipo_registro_validate_descricao__cb

  // ---------- Validate data_insert_
  function do_ajax_form_aravisa_tipo_registro_validate_data_insert_(iNumLinha)
  {
    var nomeCampo_data_insert_ = "data_insert_" + iNumLinha;
    var var_data_insert_ = scAjaxGetFieldHidden(nomeCampo_data_insert_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_validate_data_insert_(var_data_insert_, iNumLinha, var_script_case_init, do_ajax_form_aravisa_tipo_registro_validate_data_insert__cb);
  } // do_ajax_form_aravisa_tipo_registro_validate_data_insert_

  function do_ajax_form_aravisa_tipo_registro_validate_data_insert__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "data_insert_" + iLineNumber;
    }
    else
    {
      sFieldValid = "data_insert_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "data_insert_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "data_insert_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_tipo_registro_validate_data_insert__cb

  // ---------- Validate data_update_
  function do_ajax_form_aravisa_tipo_registro_validate_data_update_(iNumLinha)
  {
    var nomeCampo_data_update_ = "data_update_" + iNumLinha;
    var nomeCampo_data_update__hora = "data_update__hora" + iNumLinha;
    var var_data_update_ = scAjaxGetFieldHidden(nomeCampo_data_update_);
    var var_data_update__hora = scAjaxGetFieldHidden(nomeCampo_data_update__hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_validate_data_update_(var_data_update_, var_data_update__hora, iNumLinha, var_script_case_init, do_ajax_form_aravisa_tipo_registro_validate_data_update__cb);
  } // do_ajax_form_aravisa_tipo_registro_validate_data_update_

  function do_ajax_form_aravisa_tipo_registro_validate_data_update__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "data_update_" + iLineNumber;
    }
    else
    {
      sFieldValid = "data_update_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "data_update_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "data_update_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_tipo_registro_validate_data_update__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_aravisa_tipo_registro_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_aravisa_tipo_registro_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aravisa_tipo_registro_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_aravisa_tipo_registro_add_new_line_cb);
  } // do_ajax_form_aravisa_tipo_registro_add_new_line

  function do_ajax_form_aravisa_tipo_registro_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_aravisa_tipo_registro_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_aravisa_tipo_registro_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_tipo_registro_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_aravisa_tipo_registro_backup_line_cb);
  } // do_ajax_form_aravisa_tipo_registro_backup_line

  function do_ajax_form_aravisa_tipo_registro_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_aravisa_tipo_registro_backup_line_cb

  function do_ajax_form_aravisa_tipo_registro_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_aravisa_tipo_registro_cancel_insert

  function do_ajax_form_aravisa_tipo_registro_cancel_update(iSeqVert)
  {
    do_ajax_form_aravisa_tipo_registro_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_aravisa_tipo_registro_cancel_update

  function do_ajax_form_aravisa_tipo_registro_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_aravisa_tipo_registro_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_aravisa_tipo_registro_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_aravisa_tipo_registro_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aravisa_tipo_registro_table_refresh_cb);
  } //  do_ajax_form_aravisa_tipo_registro_table_refresh

  function do_ajax_form_aravisa_tipo_registro_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_aravisa_tipo_registro_table_refresh_cb_after_alert);
  } // do_ajax_form_aravisa_tipo_registro_table_refresh_cb
  function do_ajax_form_aravisa_tipo_registro_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_aravisa_tipo_registro_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_aravisa_tipo_registro_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_aravisa_tipo_registro_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_status_ = scAjaxGetFieldCheckbox("status_" + iNumLinha, ";");
    var var_descricao_ = scAjaxGetFieldText("descricao_" + iNumLinha);
    var var_data_insert_ = scAjaxGetFieldHidden("data_insert_" + iNumLinha);
    var var_data_update_ = scAjaxGetFieldHidden("data_update_" + iNumLinha);
    var var_data_update__hora = scAjaxGetFieldHidden("data_update__hora" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_aravisa_tipo_registro_submit_form(var_id_, var_status_, var_descricao_, var_data_insert_, var_data_update_, var_data_update__hora, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aravisa_tipo_registro_submit_form_cb);
  } // do_ajax_form_aravisa_tipo_registro_submit_form

  function do_ajax_form_aravisa_tipo_registro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("descricao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("data_insert_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("data_update_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aravisa_tipo_registro_submit_form_cb_after_alert);
  } // do_ajax_form_aravisa_tipo_registro_submit_form_cb
  function do_ajax_form_aravisa_tipo_registro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aravisa_tipo_registro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aravisa_tipo_registro_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aravisa_tipo_registro_navigate_form, function() {});
    } else {
      perform_ajax_form_aravisa_tipo_registro_navigate_form();
    }
  }

  function perform_ajax_form_aravisa_tipo_registro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_aravisa_tipo_registro_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("descricao_" + iNavForm);
      scAjaxHideErrorDisplay("data_insert_" + iNavForm);
      scAjaxHideErrorDisplay("data_update_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aravisa_tipo_registro_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aravisa_tipo_registro_navigate_form_cb);
  } // do_ajax_form_aravisa_tipo_registro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_tipo_registro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aravisa_tipo_registro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aravisa_tipo_registro_navigate_form_cb_after_alert);
  } // do_ajax_form_aravisa_tipo_registro_navigate_form_cb
  function do_ajax_form_aravisa_tipo_registro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_aravisa_tipo_registro_navigate_form_cb_after_alert
  function sc_hide_form_aravisa_tipo_registro_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descricao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "data_insert_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "data_update_" + iNumLinha;
    iTotCampos++;
    ajax_field_Dt_Hr[iTotDt_Hr] = "data_update__hora" + iNumLinha;
    iTotDt_Hr++;
    ajax_error_list["id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_tipo_registro_fld_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["descricao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_tipo_registro_fld_descricao'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["data_insert_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_tipo_registro_fld_data_insert'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["data_update_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_tipo_registro_fld_data_update'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["status_"][iNumLinha] = "status_" + iNumLinha;
    ajax_field_mult["descricao_"][iNumLinha] = "descricao_" + iNumLinha;
    ajax_field_mult["data_insert_"][iNumLinha] = "data_insert_" + iNumLinha;
    ajax_field_mult["data_update_"][iNumLinha] = "data_update_" + iNumLinha;
    ...
    ajax_field_id["descricao_" + iNumLinha] = new Array("hidden_field_label_descricao_", "hidden_field_data_descricao_" + iNumLinha);
    ajax_field_id["data_insert_" + iNumLinha] = new Array("hidden_field_label_data_insert_", "hidden_field_data_data_insert_" + iNumLinha);
    ajax_field_id["data_update_" + iNumLinha] = new Array("hidden_field_label_data_update_", "hidden_field_data_data_update_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["status_" + iNumLinha] = "off";
    ajax_error_count["descricao_" + iNumLinha] = "off";
    ajax_error_count["data_insert_" + iNumLinha] = "off";
    ajax_error_count["data_update_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["descricao_" + iNumLinha] = "off";
    ajax_read_only["data_insert_" + iNumLinha] = "off";
    ajax_read_only["data_update_" + iNumLinha] = "off";
    ajax_read_only["data_update__hora" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["descricao_" + iNumLinha] = "on";
    ajax_read_only["data_insert_" + iNumLinha] = "on";
    ajax_read_only["data_update_" + iNumLinha] = "on";
    ajax_read_only["data_update__hora" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["descricao_" + iNumLinha] = null;
    ajax_error_list["data_insert_" + iNumLinha] = null;
    ajax_error_list["data_update_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "status_": new Array(),
    "descricao_": new Array(),
    "data_insert_": new Array(),
    "data_update_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["descricao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descricao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descricao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descricao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descricao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["data_insert_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["data_insert_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["data_insert_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["data_insert_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["data_insert_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["data_update_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["data_update_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["data_update_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["data_update_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["data_update_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descricao_'])) ? $this->nmgp_cmp_readonly['descricao_'] : 'off';
?>
    scAjaxFieldRead("descricao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['data_insert_'])) ? $this->nmgp_cmp_readonly['data_insert_'] : 'off';
?>
    scAjaxFieldRead("data_insert_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['data_update_'])) ? $this->nmgp_cmp_readonly['data_update_'] : 'off';
?>
    scAjaxFieldRead("data_update_" + iSeq, "<?php echo $NM_contr_readonly ?>");
    scAjaxFieldRead("data_update__hora" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("descricao_" + iSeq, "on");
    scAjaxFieldRead("data_insert_" + iSeq, "on");
    scAjaxFieldRead("data_update_" + iSeq, "on");
    scAjaxFieldRead("data_update__hora" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["status_" + iRow] || "on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["data_insert_" + iRow] || "on" == ajax_error_count["data_update_" + iRow]))
    {
      ...
      $("#hidden_field_data_descricao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_insert_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_update_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["status_" + iRow] && "off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["data_insert_" + iRow] && "off" == ajax_error_count["data_update_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["status_" + iRow] = "off";
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["data_insert_" + iRow] = "off";
        ajax_error_count["data_update_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_descricao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_data_insert_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_data_update_" + iRow).removeClass("scFormErrorLine");
    }
  }
