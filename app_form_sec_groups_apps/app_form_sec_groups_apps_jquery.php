...
function scEventControl_init(iSeqRow) {
  scEventControl_data["app_nome_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["app_nome_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["app_nome_" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_app_nome_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_app_nome__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_app_form_sec_groups_apps_app_nome__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_app_form_sec_groups_apps_app_nome__onfocus(this, iSeqRow) });
...
function sc_app_form_sec_groups_apps_app_nome__onblur(oThis, iSeqRow) {
  do_ajax_app_form_sec_groups_apps_validate_app_nome_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app_form_sec_groups_apps_app_nome__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app_form_sec_groups_apps_app_nome__onfocus(oThis, iSeqRow) {
...
function displayChange_block_0(status) {
	displayChange_field("app_nome_", "", status);
...
function displayChange_row(row, status) {
	displayChange_field_app_nome_(row, status);
...
function displayChange_field_app_nome_(row, status) {
}
