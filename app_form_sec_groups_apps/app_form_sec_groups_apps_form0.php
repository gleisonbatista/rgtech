...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['app_nome_']) && $this->nmgp_cmp_hidden['app_nome_'] == 'off') { $sStyleHidden_app_nome_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['app_nome_']) || $this->nmgp_cmp_hidden['app_nome_'] == 'on') {
      if (!isset($this->nm_new_label['app_nome_'])) {
          $this->nm_new_label['app_nome_'] = "" . $this->Ini->Nm_lang['lang_sec_app_name'] . ""; } ?>

    <TD class="scFormLabelOddMult css_app_nome__label" id="hidden_field_label_app_nome_" style="<?php echo $sStyleHidden_app_nome_; ?>" >       
<?php
      $SC_Label = "" . $this->nm_new_label['app_nome_']  . "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "app_nome")
      {
          $orderColName = "app_nome";
      ...
      $prep_link_img = (empty($nome_img) || $this->Ini->Export_img_zip) ? '' : "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_nome\" />";
      $link_a = "<a href=\"javascript:nm_move('ordem', 'app_nome')\" class=\"scFormLabelLink scFormLabelLinkOddMult\"";
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_access")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_insert")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_delete")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_update")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_export")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "priv_print")
      {
...
{ 
   ...
   foreach ($this->form_vert_app_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       ...
       {
           $this->nmgp_cmp_readonly['app_nome_'] = true;
       ...
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['app_nome_']) || $this->nmgp_cmp_readonly['app_nome_'] != "on") {$this->nmgp_cmp_readonly['app_nome_'] = false;}
        ...
        $this->app_nome_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['app_nome_']; 
       if (empty($this->app_nome_))
       {
           $this->app_nome_ = "";
       }
       $app_nome_ = $this->app_nome_; 
       $sStyleHidden_app_nome_ = '';
       if (isset($sCheckRead_app_nome_))
       {
           unset($sCheckRead_app_nome_);
       }
       if (isset($this->nmgp_cmp_readonly['app_nome_']))
       {
           $sCheckRead_app_nome_ = $this->nmgp_cmp_readonly['app_nome_'];
       }
       if (isset($this->nmgp_cmp_hidden['app_nome_']) && $this->nmgp_cmp_hidden['app_nome_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['app_nome_']);
           $sStyleHidden_app_nome_ = 'display: none;';
       }
       $bTestReadOnly_app_nome_ = true;
       $sStyleReadLab_app_nome_ = 'display: none;';
       $sStyleReadInp_app_nome_ = '';
       if (isset($this->nmgp_cmp_readonly['app_nome_']) && $this->nmgp_cmp_readonly['app_nome_'] == 'on')
       {
           $bTestReadOnly_app_nome_ = false;
           unset($this->nmgp_cmp_readonly['app_nome_']);
           $sStyleReadLab_app_nome_ = '';
           $sStyleReadInp_app_nome_ = 'display: none;';
       }
       $this->priv_access_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_access_']; 
       ...
       $this->priv_insert_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_insert_']; 
       ...
       $this->priv_delete_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_delete_']; 
       ...
       $this->priv_update_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_update_']; 
       ...
       $this->priv_export_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_export_']; 
       ...
       $this->priv_print_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['priv_print_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_app_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "do_ajax_app_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
   ...
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['app_nome_']) && $this->nmgp_cmp_hidden['app_nome_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="app_nome_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($app_nome_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_app_nome__line" id="hidden_field_data_app_nome_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_app_nome_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_app_nome__line" style="vertical-align: top;padding: 0px"><span id="id_ajax_label_app_nome_<?php echo $sc_seq_vert; ?>"><?php echo $app_nome_?></span>
<input type="hidden" name="app_nome_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($app_nome_); ?>">
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_app_nome_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_app_nome_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y'; ?>
...
<?php   
        if (isset($sCheckRead_app_nome_))
       {
           $this->nmgp_cmp_readonly['app_nome_'] = $sCheckRead_app_nome_;
       }
       if ('display: none;' == $sStyleHidden_app_nome_)
       {
           $this->nmgp_cmp_hidden['app_nome_'] = 'off';
       }
       if (isset($sCheckRead_priv_access_))
       {
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "Voltar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-7", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bvoltar", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "Voltar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-9", "", "");?>
