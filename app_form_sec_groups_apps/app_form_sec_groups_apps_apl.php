...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['app_nome_']))
          {
              $this->app_nome_ = $this->NM_ajax_info['param']['app_nome_'];
          }
      ...
      $this->sc_conv_var['app_nome'] = "app_nome_";
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 if ($cadapar[0] == "app_nome_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= "app_nome = '" . $this->app_nome_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['nm_run_menu'] = 1;
      } 
...
if (!isset($this->sc_temp_group)) {$this->sc_temp_group = (isset($_SESSION['group'])) ? $_SESSION['group'] : "";}
 $str_sql = "SELECT descricao FROM pref_grupos WHERE grupo_id = ".$this->Db->qstr( $this->sc_temp_group );
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['app_nome_'] = '' . $this->Ini->Nm_lang['lang_sec_app_name'] . '';
      ...
      $_SESSION['scriptcase']['error_icon']['app_form_sec_groups_apps']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['table_refresh'] = false;
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['buttonStatus'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app_form_sec_groups_apps'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app_form_sec_groups_apps'];
      ...
      { 
         ...
         { 
             if ($this->grupo_id_ != "" || $this->app_nome_ != "")   
             { 
...
if (!isset($this->sc_temp_arr_apps)) {$this->sc_temp_arr_apps = (isset($_SESSION['arr_apps'])) ? $_SESSION['arr_apps'] : "";}
 $check_sql = "SELECT app_nome, app_tipo"
	   . " FROM pref_apps";
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app_form_sec_groups_apps']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app_form_sec_groups_apps']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      {
         if (isset($this->app_nome_)) { $this->nm_limpa_alfa($this->app_nome_); }
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_form'][$sc_seq_vert]))
         {
             ...
             $this->grupo_id_ = $this->nmgp_dados_form['grupo_id_']; 
         }
      ...
      { 
         ...
         { 
             $GLOBALS["priv_export_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_export_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["priv_print_" . $sc_seq_vert]))
         { 
             $GLOBALS["priv_print_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_print_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["priv_insert_" . $sc_seq_vert]))
         { 
             $GLOBALS["priv_insert_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_insert_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["priv_delete_" . $sc_seq_vert]))
         { 
             $GLOBALS["priv_delete_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_delete_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["priv_update_" . $sc_seq_vert]))
         { 
             $GLOBALS["priv_update_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_update_'];
         } 
         $this->app_nome_ = $GLOBALS["app_nome_" . $sc_seq_vert]; 
         ...
         else
         {
             ...
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['app_nome_'] =  $this->app_nome_; 
             ...
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['grupo_id_'] =  $this->grupo_id_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['fldList']['app_nome_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['app_nome_']);
          $this->NM_close_db();
          app_form_sec_groups_apps_pack_ajax_response();
          exit;
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "app_form_sec_groups_apps.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="app_form_sec_groups_apps_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="app_form_sec_groups_apps"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_app_form_sec_groups_apps'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['app_nome_'] = $this->app_nome_;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['grupo_id_']['keyVal'] = app_form_sec_groups_apps_pack_protect_string($this->nmgp_dados_form['grupo_id_']);
              $this->NM_ajax_info['fldList']['app_nome_']['keyVal'] = app_form_sec_groups_apps_pack_protect_string($this->nmgp_dados_form['app_nome_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          if (isset($this->nmgp_refresh_fields) && isset($this->nmgp_refresh_row) && '' != $this->nmgp_refresh_row)
          {
              ...
              {
                  if (isset($this->NM_ajax_changed['app_nome_']) && $this->NM_ajax_changed['app_nome_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['app_nome_'] = $this->app_nome_;
                  }
          ...
          foreach($this->form_vert_app_form_sec_groups_apps as $sc_seq_vert => $aRecData)
          {
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("app_nome_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['app_nome_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  if (empty($aRecData['app_nome_']))
                  {
                      $aRecData['app_nome_'] = "";
                  }
                  $this->NM_ajax_info['fldList']['app_nome_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("priv_access_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_access_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_insert_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_delete_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_update_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_export_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y';
          ...
          {
              $this->NM_ajax_info['fldList']['priv_print_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
{
    $original_app_nome_ = $this->app_nome_;
}
if (!isset($this->sc_temp_arr_apps)) {$this->sc_temp_arr_apps = (isset($_SESSION['arr_apps'])) ? $_SESSION['arr_apps'] : "";}
 if( isset( $this->sc_temp_arr_apps[ $this->app_nome_  ] ) )
{
	switch(trim($this->sc_temp_arr_apps[ $this->app_nome_  ]))
	{
		case 'form':
		break;
		case 'calendar':
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_app_nome_ != $this->app_nome_ || (isset($bFlagRead_app_nome_) && $bFlagRead_app_nome_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['app_nome_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['app_nome_' . $this->nmgp_refresh_row]['valList'] = array($this->app_nome_);
        $this->NM_ajax_changed['app_nome_'] = true;
    }
}
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
          }
...
//----------- 
   ...
   { 
      ...
      {
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['app_nome_'] == $this->app_nome_ &&
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['app_nome_'] = $this->app_nome_;
      ...
      $NM_val_form['app_nome_'] = $this->app_nome_;
      ...
      {
          $this->app_nome__before_qstr = $this->app_nome_;
          $this->app_nome_ = substr($this->Db->qstr($this->app_nome_), 1, -1); 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and app_nome = '$this->app_nome_' ";
          $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and app_nome = '$this->app_nome_' "); 
          if ($rs1 === false)  
          { 
              $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              if ($this->NM_ajax_flag)
          ...
          { 
              ...
              $comando .= " WHERE grupo_id = $this->grupo_id_ and app_nome = '$this->app_nome_' ";  
              ...
              $this->app_nome_ = $this->app_nome__before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['app_nome_'])) { $this->app_nome_ = $NM_val_form['app_nome_']; }
              elseif (isset($this->app_nome_)) { $this->nm_limpa_alfa($this->app_nome_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('app_nome_', 'priv_access_', 'priv_insert_', 'priv_delete_', 'priv_update_', 'priv_export_', 'priv_print_'), $aDoNotUpdate);
              $this->nmgp_refresh_fields = $aOldRefresh;

              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {

                  $this->NM_ajax_info['readOnly']['app_nome_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "grupo_id, app_nome, priv_access, priv_insert, priv_delete, priv_update, priv_export, priv_print) VALUES (" . $NM_seq_auto . "$this->grupo_id_, '$this->app_nome_', '$this->priv_access_', '$this->priv_insert_', '$this->priv_delete_', '$this->priv_update_', '$this->priv_export_', '$this->priv_print_')"; 
              }
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $tmpLabel_app_nome_ = $this->app_nome_;
                  $this->NM_ajax_info['fldList']['app_nome_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['app_nome_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->app_nome_)));
                  $this->NM_ajax_info['fldList']['app_nome_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_app_nome_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['app_nome_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['app_nome_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y';
          ...
          {
              $aTemp_priv_access_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y';
          ...
          {
              $aTemp_priv_insert_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y';
          ...
          {
              $aTemp_priv_delete_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y';
          ...
          {
              $aTemp_priv_update_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y';
          ...
          {
              $aTemp_priv_export_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y';
          ...
          {
              $aTemp_priv_print_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
          ...
          $tmpLabel_priv_print_ = $sLabelTemp;
              ...
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              $rs1->Close(); 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and app_nome = '$this->app_nome_' "; 
              $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and app_nome = '$this->app_nome_' "); 
              if ($rs === false) 
              { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['parms'] = "grupo_id_?#?$this->grupo_id_?@?app_nome_?#?$this->app_nome_?@?"; 
      }
      if ($this->sc_evento != "insert" && $this->sc_evento != "update" && $this->sc_evento != "delete")
      { 
          $this->grupo_id_ = null === $this->grupo_id_ ? null : substr($this->Db->qstr($this->grupo_id_), 1, -1); 
          $this->app_nome_ = null === $this->app_nome_ ? null : substr($this->Db->qstr($this->app_nome_), 1, -1); 
      } 
   }
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter'])
      {
      ...
      {
          $aNewWhereCond = array();
          if (null != $this->app_nome_)
          {
              $aNewWhereCond[] = "app_nome = '" . substr($this->Db->qstr($this->app_nome_), 1, -1) . "'";
          }
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->grupo_id_) && !empty($this->app_nome_))
          {
              $Reg_OK      = false;
              $Count_start = -1;
              $sc_order_by = "";
              $Sel_Chave = "grupo_id, app_nome"; 
              $nmgp_select = "SELECT " . $Sel_Chave . " from " . $this->Ini->nm_tabela . $sc_where; 
              $sc_order_by = "grupo_id, app_nome";
              ...
              while (!$rt->EOF && !$Reg_OK)
              { 
                  if ($rt->fields[0] == $this->grupo_id_ && $rt->fields[1] == $this->app_nome_)
                  { 
                      $Reg_OK = true;
                  }  
                  $Count_start++;
      ...
      $nmgp_select = "SELECT grupo_id, app_nome, priv_access, priv_insert, priv_delete, priv_update, priv_export, priv_print from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      if ($this->nmgp_opcao != "novo") 
      { 
      ...
      else
      {
          ...
          { 
              ...
              $this->app_nome_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['app_nome_'] = $this->app_nome_;
   ...
   function NM_gera_nav_page() 
   {
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("group_id", "app_name", "priv_access_", "priv_insert_", "priv_delete_", "priv_update_", "priv_export_", "priv_print_"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app_form_sec_groups_apps_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['masterValue']))
{
