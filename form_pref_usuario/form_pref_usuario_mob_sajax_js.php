  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pref_usuario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pref_usuario_mob_form();
	}
  ...
  // ---------- Validate titulo
  function do_ajax_form_pref_usuario_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_titulo_cb);
  } // do_ajax_form_pref_usuario_mob_validate_titulo

  function do_ajax_form_pref_usuario_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_titulo_cb

  // ---------- Validate nome
  function do_ajax_form_pref_usuario_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_nome_cb);
  } // do_ajax_form_pref_usuario_mob_validate_nome

  function do_ajax_form_pref_usuario_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_nome_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_form_pref_usuario_mob_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_cpf_cnpj_cb);
  } // do_ajax_form_pref_usuario_mob_validate_cpf_cnpj

  function do_ajax_form_pref_usuario_mob_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf_cnpj";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_cpf_cnpj_cb

  // ---------- Validate telefone
  function do_ajax_form_pref_usuario_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_telefone_cb);
  } // do_ajax_form_pref_usuario_mob_validate_telefone

  function do_ajax_form_pref_usuario_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telefone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_pref_usuario_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_email(var_email, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_email_cb);
  } // do_ajax_form_pref_usuario_mob_validate_email

  function do_ajax_form_pref_usuario_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_email_cb

  // ---------- Validate priv_admin
  function do_ajax_form_pref_usuario_mob_validate_priv_admin()
  {
    var nomeCampo_priv_admin = "priv_admin";
    var var_priv_admin = scAjaxGetFieldText(nomeCampo_priv_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_priv_admin(var_priv_admin, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_priv_admin_cb);
  } // do_ajax_form_pref_usuario_mob_validate_priv_admin

  function do_ajax_form_pref_usuario_mob_validate_priv_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_priv_admin_cb

  // ---------- Validate rg
  function do_ajax_form_pref_usuario_mob_validate_rg()
  {
    var nomeCampo_rg = "rg";
    var var_rg = scAjaxGetFieldText(nomeCampo_rg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_rg(var_rg, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_rg_cb);
  } // do_ajax_form_pref_usuario_mob_validate_rg

  function do_ajax_form_pref_usuario_mob_validate_rg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rg";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_rg_cb

  // ---------- Validate orgao_emissor
  function do_ajax_form_pref_usuario_mob_validate_orgao_emissor()
  {
    var nomeCampo_orgao_emissor = "orgao_emissor";
    var var_orgao_emissor = scAjaxGetFieldText(nomeCampo_orgao_emissor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_orgao_emissor(var_orgao_emissor, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_orgao_emissor_cb);
  } // do_ajax_form_pref_usuario_mob_validate_orgao_emissor

  function do_ajax_form_pref_usuario_mob_validate_orgao_emissor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orgao_emissor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_orgao_emissor_cb

  // ---------- Validate login
  function do_ajax_form_pref_usuario_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_login(var_login, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_login_cb);
  } // do_ajax_form_pref_usuario_mob_validate_login

  function do_ajax_form_pref_usuario_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_login_cb

  // ---------- Validate senha
  function do_ajax_form_pref_usuario_mob_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_senha(var_senha, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_senha_cb);
  } // do_ajax_form_pref_usuario_mob_validate_senha

  function do_ajax_form_pref_usuario_mob_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_senha_cb

  // ---------- Validate termo
  function do_ajax_form_pref_usuario_mob_validate_termo()
  {
    var nomeCampo_termo = "termo";
    var var_termo = scAjaxGetFieldCheckbox(nomeCampo_termo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_termo(var_termo, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_termo_cb);
  } // do_ajax_form_pref_usuario_mob_validate_termo

  function do_ajax_form_pref_usuario_mob_validate_termo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "termo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_termo_cb

  // ---------- Validate tipo_cadastro
  function do_ajax_form_pref_usuario_mob_validate_tipo_cadastro()
  {
    var nomeCampo_tipo_cadastro = "tipo_cadastro";
    var var_tipo_cadastro = scAjaxGetFieldText(nomeCampo_tipo_cadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_mob_validate_tipo_cadastro(var_tipo_cadastro, var_script_case_init, do_ajax_form_pref_usuario_mob_validate_tipo_cadastro_cb);
  } // do_ajax_form_pref_usuario_mob_validate_tipo_cadastro

  function do_ajax_form_pref_usuario_mob_validate_tipo_cadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_cadastro";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_mob_validate_tipo_cadastro_cb

  // ---------- Event onchange cpf_cnpj
  function do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange()
  {
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb);
  } // do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange

  function do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf_cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb
  function do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_mob_event_cpf_cnpj_onchange_cb_after_alert

  // ---------- Event onchange email
  function do_ajax_form_pref_usuario_mob_event_email_onchange()
  {
    var var_email = scAjaxGetFieldText("email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_mob_event_email_onchange(var_email, var_script_case_init, do_ajax_form_pref_usuario_mob_event_email_onchange_cb);
  } // do_ajax_form_pref_usuario_mob_event_email_onchange

  function do_ajax_form_pref_usuario_mob_event_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_mob_event_email_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_event_email_onchange_cb
  function do_ajax_form_pref_usuario_mob_event_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_mob_event_email_onchange_cb_after_alert

  // ---------- Event onchange login
  function do_ajax_form_pref_usuario_mob_event_login_onchange()
  {
    var var_login = scAjaxGetFieldText("login");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_mob_event_login_onchange(var_login, var_script_case_init, do_ajax_form_pref_usuario_mob_event_login_onchange_cb);
  } // do_ajax_form_pref_usuario_mob_event_login_onchange

  function do_ajax_form_pref_usuario_mob_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_mob_event_login_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_event_login_onchange_cb
  function do_ajax_form_pref_usuario_mob_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_mob_event_login_onchange_cb_after_alert

  // ---------- Event onchange telefone
  function do_ajax_form_pref_usuario_mob_event_telefone_onchange()
  {
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_mob_event_telefone_onchange(var_telefone, var_script_case_init, do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb);
  } // do_ajax_form_pref_usuario_mob_event_telefone_onchange

  function do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "telefone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb
  function do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_mob_event_telefone_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pref_usuario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pref_usuario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_email = scAjaxGetFieldText("email");
    var var_priv_admin = scAjaxGetFieldText("priv_admin");
    var var_rg = scAjaxGetFieldText("rg");
    var var_orgao_emissor = scAjaxGetFieldText("orgao_emissor");
    var var_login = scAjaxGetFieldText("login");
    var var_senha = scAjaxGetFieldText("senha");
    var var_termo = scAjaxGetFieldCheckbox("termo", ";");
    var var_tipo_cadastro = scAjaxGetFieldText("tipo_cadastro");
    ...
    scAjaxProcOn();
    x_ajax_form_pref_usuario_mob_submit_form(var_titulo, var_nome, var_cpf_cnpj, var_telefone, var_email, var_priv_admin, var_rg, var_orgao_emissor, var_login, var_senha, var_termo, var_tipo_cadastro, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pref_usuario_mob_submit_form_cb);
  } // do_ajax_form_pref_usuario_mob_submit_form

  function do_ajax_form_pref_usuario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cpf_cnpj");
      scAjaxHideErrorDisplay("telefone");
      scAjaxHideErrorDisplay("email");
      scAjaxHideErrorDisplay("priv_admin");
      scAjaxHideErrorDisplay("rg");
      scAjaxHideErrorDisplay("orgao_emissor");
      scAjaxHideErrorDisplay("login");
      scAjaxHideErrorDisplay("senha");
      scAjaxHideErrorDisplay("termo");
      scAjaxHideErrorDisplay("tipo_cadastro");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pref_usuario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_submit_form_cb
  function do_ajax_form_pref_usuario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pref_usuario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pref_usuario_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pref_usuario_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pref_usuario_mob_navigate_form();
    }
  }

  function perform_ajax_form_pref_usuario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pref_usuario_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pref_usuario_mob_navigate_form_cb);
  } // do_ajax_form_pref_usuario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pref_usuario_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pref_usuario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pref_usuario_mob_navigate_form_cb
  function do_ajax_form_pref_usuario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pref_usuario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pref_usuario_mob_navigate_form_cb_after_alert
  function sc_hide_form_pref_usuario_mob_form()
  {
  ...
  ajax_field_list[2] = "cpf_cnpj";
  ajax_field_list[3] = "telefone";
  ajax_field_list[4] = "email";
  ajax_field_list[5] = "priv_admin";
  ajax_field_list[6] = "rg";
  ajax_field_list[7] = "orgao_emissor";
  ajax_field_list[8] = "login";
  ajax_field_list[9] = "senha";
  ajax_field_list[10] = "termo";
  ajax_field_list[11] = "tipo_cadastro";
  ...
  var ajax_error_list = {
    "titulo": {"label": "Cadastro de Usuário", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_nome'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpf_cnpj": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_cpf'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telefone": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_telefone'] ?><img src='https://i1.wp.com/www.marketingdevideojuegos.com/wp-content/uploads/2015/01/whatsapp_peque.fw_.png' width='20'>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "priv_admin": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_priv_admin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rg": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_rg'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "orgao_emissor": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_orgao_emissor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "senha": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_senha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "termo": {"label": "Termos & Condições", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_cadastro": {"label": "Tipo Cadastro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "rg": new Array(),
    "orgao_emissor": new Array(),
    "login": new Array(),
    "senha": new Array(),
    "termo": new Array(),
    "tipo_cadastro": new Array()
  };
  ajax_field_mult["titulo"][1] = "titulo";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["cpf_cnpj"][1] = "cpf_cnpj";
  ajax_field_mult["telefone"][1] = "telefone";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["priv_admin"][1] = "priv_admin";
  ajax_field_mult["rg"][1] = "rg";
  ajax_field_mult["orgao_emissor"][1] = "orgao_emissor";
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["senha"][1] = "senha";
  ajax_field_mult["termo"][1] = "termo";
  ajax_field_mult["tipo_cadastro"][1] = "tipo_cadastro";
  ...
  var ajax_field_id = {
    ...
    "cpf_cnpj": new Array("hidden_field_label_cpf_cnpj", "hidden_field_data_cpf_cnpj"),
    "telefone": new Array("hidden_field_label_telefone", "hidden_field_data_telefone"),
    "email": new Array("hidden_field_label_email", "hidden_field_data_email"),
    "rg": new Array("hidden_field_label_rg", "hidden_field_data_rg"),
    "orgao_emissor": new Array("hidden_field_label_orgao_emissor", "hidden_field_data_orgao_emissor"),
    ...
    "termo": new Array("hidden_field_label_termo", "hidden_field_data_termo")
  };
