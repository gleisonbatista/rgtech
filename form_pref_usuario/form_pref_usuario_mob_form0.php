...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("AraGestor - Cadastro de Uusários"); } else { echo strip_tags("AraGestor - Cadastro de Uusários"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_pref_usuario/form_pref_usuario_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_pref_usuario_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_pref_usuario_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_pref_usuario']['error_buffer']) && '' != $_SESSION['scriptcase']['form_pref_usuario']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_pref_usuario']['error_buffer'];
}
...
<?php
 include_once("form_pref_usuario_mob_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<form  name="F1" method="post" 
               action="form_pref_usuario_mob.php" 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_pref_usuario_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_pref_usuario_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['fast_search'][2] : "";
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-5", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "Concluir Cadastro", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-6", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-7", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Delete)", "sc-unique-btn-8", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + C)", "sc-unique-btn-10", "", "group_2");?>
  </div>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "breload", "scBtnFn_sys_format_reload()", "scBtnFn_sys_format_reload()", "sc_b_reload_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-11", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['tipo_cadastro']))
   {
       $this->nmgp_cmp_hidden['tipo_cadastro'] = 'off';
   }
?>
<TABLE align="center" id="hidden_bloco_0" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['titulo'] = "Cadastro de Usuário";
    }
?>
<?php
...
<span id="id_read_on_cpf_cnpj" class="sc-ui-readonly-cpf_cnpj css_cpf_cnpj_line" style="<?php echo $sStyleReadLab_cpf_cnpj; ?>"><?php echo $this->form_format_readonly("cpf_cnpj", $this->form_encode_input($this->cpf_cnpj)); ?></span><span id="id_read_off_cpf_cnpj" class="css_read_off_cpf_cnpj<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_cpf_cnpj; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> alt="{datatype: 'cpf', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: 'Somente números', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<TABLE align="center" id="hidden_bloco_2" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">Dados de acesso</TD>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_format_readonly("login", $this->form_encode_input($this->login)); ?></span><span id="id_read_off_login" class="css_read_off_login<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_senha_line" id="hidden_field_data_senha" style="<?php echo $sStyleHidden_senha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_senha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_senha_label" style=""><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['php_cmp_required']['senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["senha"]) &&  $this->nmgp_cmp_readonly["senha"] == "on") { ?>
<input type="hidden" name="senha" value="">
<?php } else { ?>
<span id="id_read_on_senha" class="sc-ui-readonly-senha css_senha_line" style="<?php echo $sStyleReadLab_senha; ?>"><?php echo $this->form_format_readonly("senha", $this->form_encode_input($this->senha)); ?></span><span id="id_read_off_senha" class="css_read_off_senha<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_senha; ?>"><div class="scFormObjectOddPwdBox"><input class="sc-js-input scFormObjectOddPwdInput scFormObjectOddPwdText sc-ui-pwd-toggle css_senha_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_senha" type="password" autocomplete="off" name="senha" value="" 
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ><span id="id_pwd_show_hide_senha" class="sc-ui-pwd-toggle-icon"><i class="fa fa-eye sc-ui-pwd-eye" aria-hidden="true" id="id_pwd_fa_senha"></i></span></div></span><?php } ?>
<span class="scFormDataTagOdd" style="display: block">Mínimo de 6 caracteres</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_senha_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_senha_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['termo']))
   {
   ...
   $termo = $this->termo;
   $sStyleHidden_termo = '';
   if (isset($this->nmgp_cmp_hidden['termo']) && $this->nmgp_cmp_hidden['termo'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['termo']);
       $sStyleHidden_termo = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_termo = 'display: none;';
   $sStyleReadInp_termo = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['termo']) && $this->nmgp_cmp_readonly['termo'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['termo']);
       $sStyleReadLab_termo = '';
       $sStyleReadInp_termo = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['termo']) && $this->nmgp_cmp_hidden['termo'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="termo" value="<?php echo $this->form_encode_input($this->termo) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->termo_1 = explode(";", trim($this->termo));
  } 
  else
  {
      if (empty($this->termo))
      ...
      else
      {
          ...
          $this->termo= ""; 
          foreach ($this->termo_1 as $cada_termo)
          {
             if (!empty($termo))
             {
                 $this->termo.= ";"; 
             } 
             $this->termo.= $cada_termo; 
          } 
      } 
  } 
?> 

    <TD class="scFormDataOdd css_termo_line" id="hidden_field_data_termo" style="<?php echo $sStyleHidden_termo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_termo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_termo_label" style=""><span id="id_label_termo"><?php echo $this->nm_new_label['termo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['php_cmp_required']['termo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['php_cmp_required']['termo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["termo"]) &&  $this->nmgp_cmp_readonly["termo"] == "on") { 

$termo_look = "";
 if (in_array("S", $this->termo_1))  { $termo_look .= "Declaro ter lido e estou de acordo.<br />";} 
?>
<input type="hidden" name="termo" value="<?php echo $this->form_encode_input($termo) . "\">" . $termo_look . ""; ?>
<?php } else { ?>
...
$termo_look = "";
 if (in_array("S", $this->termo_1))  { $termo_look .= "Declaro ter lido e estou de acordo.<br />";} 
?>
<span id="id_read_on_termo" class="css_termo_line" style="<?php echo $sStyleReadLab_termo; ?>"><?php echo $this->form_format_readonly("termo", $this->form_encode_input($termo_look)); ?></span><span id="id_read_off_termo" class="css_read_off_termo css_termo_line" style="<?php echo $sStyleReadInp_termo; ?>"><?php echo "<div id=\"idAjaxCheckbox_termo\" style=\"display: inline-block\" class=\"css_termo_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_termo_line"><?php $tempOptionId = "id-opt-termo" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-termo sc-ui-checkbox-termo sc-js-input" name="termo[]" value="S"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['Lookup_termo'][] = 'S'; ?>
<?php  if (in_array("S", $this->termo_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">Declaro ter lido e estou de acordo.</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_termo_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_termo_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['tipo_cadastro']))
    {
        $this->nm_new_label['tipo_cadastro'] = "Tipo Cadastro";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_tipo_cadastro = '';
   if (isset($this->nmgp_cmp_hidden['tipo_cadastro']) && $this->nmgp_cmp_hidden['tipo_cadastro'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['tipo_cadastro']);
       $sStyleHidden_tipo_cadastro = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_tipo_cadastro = 'display: none;';
   $sStyleReadInp_tipo_cadastro = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['tipo_cadastro']) && $this->nmgp_cmp_readonly['tipo_cadastro'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['tipo_cadastro']);
       $sStyleReadLab_tipo_cadastro = '';
       $sStyleReadInp_tipo_cadastro = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['tipo_cadastro']) && $this->nmgp_cmp_hidden['tipo_cadastro'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="tipo_cadastro" value="<?php echo $this->form_encode_input($tipo_cadastro) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_tipo_cadastro_line" id="hidden_field_data_tipo_cadastro" style="<?php echo $sStyleHidden_tipo_cadastro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_cadastro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_cadastro_label" style=""><span id="id_label_tipo_cadastro"><?php echo $this->nm_new_label['tipo_cadastro']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tipo_cadastro"]) &&  $this->nmgp_cmp_readonly["tipo_cadastro"] == "on") { 

 ?>
<input type="hidden" name="tipo_cadastro" value="<?php echo $this->form_encode_input($tipo_cadastro) . "\">" . $tipo_cadastro . ""; ?>
<?php } else { ?>
<span id="id_read_on_tipo_cadastro" class="sc-ui-readonly-tipo_cadastro css_tipo_cadastro_line" style="<?php echo $sStyleReadLab_tipo_cadastro; ?>"><?php echo $this->form_format_readonly("tipo_cadastro", $this->form_encode_input($this->tipo_cadastro)); ?></span><span id="id_read_off_tipo_cadastro" class="css_read_off_tipo_cadastro<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_tipo_cadastro; ?>">
 <input class="sc-js-input scFormObjectOdd css_tipo_cadastro_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_tipo_cadastro" type=text name="tipo_cadastro" value="<?php echo $this->form_encode_input($tipo_cadastro) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tipo_cadastro_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tipo_cadastro_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8592;)", "sc-unique-btn-15", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8592;)", "sc-unique-btn-16", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8594;)", "sc-unique-btn-17", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_pref_usuario_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_pref_usuario_mob");
 parent.scAjaxDetailHeight("form_pref_usuario_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_tela_login() {
		if ($("#sc_tela_login_bot").length && $("#sc_tela_login_bot").is(":visible")) {
			sc_btn_tela_login()
			 return;
		}
	}
	...
	function scBtnFn_sys_format_copy() {
		if ($("#sc_b_clone_t.sc-unique-btn-10").length && $("#sc_b_clone_t.sc-unique-btn-10").is(":visible")) {
			nm_move ('clone');
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
