<?php
@session_start() ;
$_SESSION['scriptcase']['grid_aracash_pagamento_historico_user']['sc_process_barr'] = true;
require_once('../grid_aracash_pagamento_historico_user/index.php');
unset($_SESSION['scriptcase']['grid_aracash_pagamento_historico_user']['sc_process_barr']);
$ExportCtrl = new grid_aracash_pagamento_historico_user_export_control;
$ExportCtrl->Export_barr();

class grid_aracash_pagamento_historico_user_export_control
{
