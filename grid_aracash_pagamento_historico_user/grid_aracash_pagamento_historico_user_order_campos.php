...
<?php
   ...
   $Ord_Cmp = new grid_aracash_pagamento_historico_user_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aracash_pagamento_historico_user_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_registro'] = "id_registro";
   $tab_labels["id_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["id_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["id_registro"] : "Cód. da Solicitação";
   $tab_ger_campos['valor_pago'] = "on";
   $tab_def_campos['valor_pago'] = "valor_pago";
   $tab_labels["valor_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["valor_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["valor_pago"] : "Valor pago";
   $tab_ger_campos['data_insert'] = "on";
   $tab_def_campos['data_insert'] = "data_insert";
   $tab_labels["data_insert"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["data_insert"])) ? $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['labels']["data_insert"] : "Data";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aracash_pagamento_historico_user_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_aracash_pagamento_historico_user']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
