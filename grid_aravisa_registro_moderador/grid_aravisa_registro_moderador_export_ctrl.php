<?php
@session_start() ;
$_SESSION['scriptcase']['grid_aravisa_registro_moderador']['sc_process_barr'] = true;
require_once('../grid_aravisa_registro_moderador/index.php');
unset($_SESSION['scriptcase']['grid_aravisa_registro_moderador']['sc_process_barr']);
$ExportCtrl = new grid_aravisa_registro_moderador_export_control;
$ExportCtrl->Export_barr();

class grid_aravisa_registro_moderador_export_control
{
