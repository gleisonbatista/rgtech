...
$old_error_handler = set_error_handler("app_Login_scriptcase_error_handler");

function app_Login_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['app_Login']['contr_erro']) && $_SESSION['scriptcase']['app_Login']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_app_Login->contr_app_Login->Apl_com_erro = true;
            if ($inicial_app_Login->contr_app_Login->NM_ajax_flag)
            {
                $inicial_app_Login->contr_app_Login->NM_ajax_info['errList']['geral_app_Login'][] = $msg;
                return;
            }
            app_Login_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function app_Login_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['app_Login']) && '' != $_SESSION['scriptcase']['error_span_title']['app_Login']) ? $_SESSION['scriptcase']['error_span_title']['app_Login'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['app_Login']) && '' != $_SESSION['scriptcase']['error_icon_title']['app_Login']) ? $_SESSION['scriptcase']['error_icon_title']['app_Login'] : '';
?>
