...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
        ...
        $sCondStyle = ($this->nmgp_botoes['criar_conta'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "criar_conta", "scBtnFn_criar_conta()", "scBtnFn_criar_conta()", "sc_criar_conta_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
           if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['criar_conta_empresa'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "criar_conta_empresa", "scBtnFn_criar_conta_empresa()", "scBtnFn_criar_conta_empresa()", "sc_criar_conta_empresa_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", "Acessar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-2", "", "");?>
