...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="app_Login_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_criar_conta()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_criar_conta(); }, 500);
      return;
    }
    sc_btn_criar_conta_ok();
}
function sc_btn_criar_conta_cancel()
{
}
function sc_btn_criar_conta_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_pref_usuario_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_pref_usuario');
}
function sc_btn_criar_conta_empresa()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_criar_conta_empresa(); }, 500);
      return;
    }
    sc_btn_criar_conta_empresa_ok();
}
function sc_btn_criar_conta_empresa_cancel()
{
}
function sc_btn_criar_conta_empresa_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_pref_empresa_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_pref_empresa');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "app_Login_mob_fim.php";
  document.F4.submit();
}
