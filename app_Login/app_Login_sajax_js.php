...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_remember_me, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_submit_form_cb);
...
?>
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['dashboard_info']['parent_widget'] ?>";
...
{
?>
    do_ajax_app_Login_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
