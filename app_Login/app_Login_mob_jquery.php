...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_remember_me' + iSeqRow).bind('blur', function() { sc_app_Login_remember_me_onblur(this, iSeqRow) })
...
function scHidePage(pageNo) {
	$("#id_app_Login_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'app_Login_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
