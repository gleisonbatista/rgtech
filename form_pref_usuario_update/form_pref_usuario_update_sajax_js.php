  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pref_usuario_update" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pref_usuario_update_form();
	}
  ...
  // ---------- Validate nome
  function do_ajax_form_pref_usuario_update_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_nome(var_nome, var_script_case_init, do_ajax_form_pref_usuario_update_validate_nome_cb);
  } // do_ajax_form_pref_usuario_update_validate_nome

  function do_ajax_form_pref_usuario_update_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_nome_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_form_pref_usuario_update_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldHidden(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_usuario_update_validate_cpf_cnpj_cb);
  } // do_ajax_form_pref_usuario_update_validate_cpf_cnpj

  function do_ajax_form_pref_usuario_update_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_cpf_cnpj_cb

  // ---------- Validate telefone
  function do_ajax_form_pref_usuario_update_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_pref_usuario_update_validate_telefone_cb);
  } // do_ajax_form_pref_usuario_update_validate_telefone

  function do_ajax_form_pref_usuario_update_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_pref_usuario_update_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_email(var_email, var_script_case_init, do_ajax_form_pref_usuario_update_validate_email_cb);
  } // do_ajax_form_pref_usuario_update_validate_email

  function do_ajax_form_pref_usuario_update_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_email_cb

  // ---------- Validate priv_admin
  function do_ajax_form_pref_usuario_update_validate_priv_admin()
  {
    var nomeCampo_priv_admin = "priv_admin";
    var var_priv_admin = scAjaxGetFieldText(nomeCampo_priv_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_priv_admin(var_priv_admin, var_script_case_init, do_ajax_form_pref_usuario_update_validate_priv_admin_cb);
  } // do_ajax_form_pref_usuario_update_validate_priv_admin

  function do_ajax_form_pref_usuario_update_validate_priv_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_priv_admin_cb

  // ---------- Validate rg
  function do_ajax_form_pref_usuario_update_validate_rg()
  {
    var nomeCampo_rg = "rg";
    var var_rg = scAjaxGetFieldText(nomeCampo_rg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_rg(var_rg, var_script_case_init, do_ajax_form_pref_usuario_update_validate_rg_cb);
  } // do_ajax_form_pref_usuario_update_validate_rg

  function do_ajax_form_pref_usuario_update_validate_rg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rg";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_rg_cb

  // ---------- Validate orgao_emissor
  function do_ajax_form_pref_usuario_update_validate_orgao_emissor()
  {
    var nomeCampo_orgao_emissor = "orgao_emissor";
    var var_orgao_emissor = scAjaxGetFieldText(nomeCampo_orgao_emissor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_orgao_emissor(var_orgao_emissor, var_script_case_init, do_ajax_form_pref_usuario_update_validate_orgao_emissor_cb);
  } // do_ajax_form_pref_usuario_update_validate_orgao_emissor

  function do_ajax_form_pref_usuario_update_validate_orgao_emissor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_orgao_emissor_cb

  // ---------- Validate cep
  function do_ajax_form_pref_usuario_update_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_cep(var_cep, var_script_case_init, do_ajax_form_pref_usuario_update_validate_cep_cb);
  } // do_ajax_form_pref_usuario_update_validate_cep

  function do_ajax_form_pref_usuario_update_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_pref_usuario_update_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_pref_usuario_update_validate_endereco_cb);
  } // do_ajax_form_pref_usuario_update_validate_endereco

  function do_ajax_form_pref_usuario_update_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_endereco_cb

  // ---------- Validate numero
  function do_ajax_form_pref_usuario_update_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_numero(var_numero, var_script_case_init, do_ajax_form_pref_usuario_update_validate_numero_cb);
  } // do_ajax_form_pref_usuario_update_validate_numero

  function do_ajax_form_pref_usuario_update_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_numero_cb

  // ---------- Validate bairro
  function do_ajax_form_pref_usuario_update_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_usuario_update_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_pref_usuario_update_validate_bairro_cb);
  } // do_ajax_form_pref_usuario_update_validate_bairro

  function do_ajax_form_pref_usuario_update_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_usuario_update_validate_bairro_cb

  // ---------- Event onchange cpf_cnpj
  function do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange()
  {
    var var_cpf_cnpj = scAjaxGetFieldHidden("cpf_cnpj");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb);
  } // do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange

  function do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf_cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb
  function do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_update_event_cpf_cnpj_onchange_cb_after_alert

  // ---------- Event onchange email
  function do_ajax_form_pref_usuario_update_event_email_onchange()
  {
    var var_email = scAjaxGetFieldText("email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_update_event_email_onchange(var_email, var_script_case_init, do_ajax_form_pref_usuario_update_event_email_onchange_cb);
  } // do_ajax_form_pref_usuario_update_event_email_onchange

  function do_ajax_form_pref_usuario_update_event_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_update_event_email_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_event_email_onchange_cb
  function do_ajax_form_pref_usuario_update_event_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_update_event_email_onchange_cb_after_alert

  // ---------- Event onchange login
  function do_ajax_form_pref_usuario_update_event_login_onchange()
  {
    var var_login = scAjaxGetFieldText("login");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_update_event_login_onchange(var_login, var_script_case_init, do_ajax_form_pref_usuario_update_event_login_onchange_cb);
  } // do_ajax_form_pref_usuario_update_event_login_onchange

  function do_ajax_form_pref_usuario_update_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_update_event_login_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_event_login_onchange_cb
  function do_ajax_form_pref_usuario_update_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_update_event_login_onchange_cb_after_alert

  // ---------- Event onchange telefone
  function do_ajax_form_pref_usuario_update_event_telefone_onchange()
  {
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_usuario_update_event_telefone_onchange(var_telefone, var_script_case_init, do_ajax_form_pref_usuario_update_event_telefone_onchange_cb);
  } // do_ajax_form_pref_usuario_update_event_telefone_onchange

  function do_ajax_form_pref_usuario_update_event_telefone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "telefone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_usuario_update_event_telefone_onchange_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_event_telefone_onchange_cb
  function do_ajax_form_pref_usuario_update_event_telefone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_usuario_update_event_telefone_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pref_usuario_update_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pref_usuario_update_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pref_usuario_update_submit_form(var_nome, var_cpf_cnpj, var_telefone, var_email, var_priv_admin, var_rg, var_orgao_emissor, var_cep, var_endereco, var_numero, var_bairro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pref_usuario_update_submit_form_cb);
  } // do_ajax_form_pref_usuario_update_submit_form

  function do_ajax_form_pref_usuario_update_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pref_usuario_update_submit_form_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_submit_form_cb
  function do_ajax_form_pref_usuario_update_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pref_usuario_update_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pref_usuario_update_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pref_usuario_update_navigate_form, function() {});
    } else {
      perform_ajax_form_pref_usuario_update_navigate_form();
    }
  }

  function perform_ajax_form_pref_usuario_update_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pref_usuario_update_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pref_usuario_update_navigate_form_cb);
  } // do_ajax_form_pref_usuario_update_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_usuario_update']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pref_usuario_update_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pref_usuario_update_navigate_form_cb_after_alert);
  } // do_ajax_form_pref_usuario_update_navigate_form_cb
  function do_ajax_form_pref_usuario_update_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pref_usuario_update_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pref_usuario_update_navigate_form_cb_after_alert
  function sc_hide_form_pref_usuario_update_form()
  {
