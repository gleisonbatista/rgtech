   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_retrieve_pswd']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_retrieve_pswd']['label'] = "app_retrieve_pswd";
      ...
      $_SESSION['scriptcase']['error_icon']['app_retrieve_pswd']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
$_SESSION['scriptcase']['app_retrieve_pswd']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app_retrieve_pswd']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app_retrieve_pswd']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['campos'][0]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['campos'][0] = $this->login; 
...
$_SESSION['scriptcase']['app_retrieve_pswd']['contr_erro'] = 'off'; 
    ...
    function ValidateField_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['php_cmp_required']['login'] == "on")) 
      { 
          if ($this->login == "")  
          { 
              $hasError = true;
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['opc_ant'] = "";
