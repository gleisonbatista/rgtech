<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['login']['glo_nm_perfil']          = "conn_hackaton";
   $_SESSION['scriptcase']['login']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['login']['glo_nm_path_conf']       = "";
   ...
   $_SESSION['scriptcase']['login']['glo_nm_path_doc']        = "";
    ...
    {
            /*check tmp*/$_SESSION['scriptcase']['login']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_conf       = $_SESSION['scriptcase']['login']['glo_nm_path_conf'];
      ...
      if (!isset($_SESSION['scriptcase']['login']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['login']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['login']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['login']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      {
          include_once("login_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['login']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['login']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['login']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['login']['SC_Link_View'] = true;
          }
      }
    ...
    $orig_img = $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['login']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['login']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['login']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['login']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "login_erro.class.php"); 
...
/*NM*/            $_SESSION['scriptcase']['login']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['login']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['login']['embutida_init']) 
      {
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'Hackaton', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['login']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['login']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['login']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['login']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "login_erro.class.php"); 
      $this->Erro      = new login_erro();
...
$cpf = limpaCPF($_POST['cpf_app']);
$senha = md5($_POST['senha_app']);



$sql_login = "SELECT * FROM pref_usuario WHERE login = '".$cpf."' AND senha = '".$senha."'";
 
      $nm_select = $sql_login; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->ds_login = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_login = false;
          $this->ds_login_erro = $this->Db->ErrorMsg();
      } 
;

if(!$this->ds_login->EOF) {
	$primeroNome = explode(" ", $this->ds_login->fields['nome']);
	$nome = $primeroNome[0];
	
	$retornoApp = array("LOGIN"=>"SUCESSO", "NOME"=>$nome, "EMAIL"=>$this->ds_login->fields['email'], "CPF"=>$this->ds_login->fields['login'], "ID"=>$this->ds_login->fields['id'], "TELEFONE"=>$this->ds_login->fields['telefone']);
} else {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hackaton.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_Hackaton.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "login") {
           ...
           if (isset($_COOKIE['sc_actual_lang_Hackaton'])) {
               $_SESSION['scriptcase']['login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Hackaton'];
           }
       }
   }
   ...
   else
   {
       ...
       if ('login' == $sReferer || 'login_' == substr($sReferer, 0, 6))
       {
           $_SESSION['sc_session'][$script_case_init]['login']['initialize'] = false;
       }
       else
   ...
   $contr_login = new login_apl();
   $contr_login->controle();
//
