...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_aravisa_registro_moderador_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aravisa_registro_moderador_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_aravisa_registro_moderador_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aravisa_registro_moderador'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aravisa_registro_moderador'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['Lookup_status'][] = 'P'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['Lookup_status'][] = 'R'; ?>
...
<?php } 
?> 
<?php $sStyleHidden_pref_usuario_id_dumb = ('' == $sStyleHidden_pref_usuario_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_pref_usuario_id_dumb" style="<?php echo $sStyleHidden_pref_usuario_id_dumb; ?>"></TD>
...
<?php } 
?> 
<?php $sStyleHidden_imagem_dumb = ('' == $sStyleHidden_imagem) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_imagem_dumb" style="<?php echo $sStyleHidden_imagem_dumb; ?>"></TD>
<?php $sStyleHidden_imagem_resultado_dumb = ('' == $sStyleHidden_imagem_resultado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_imagem_resultado_dumb" style="<?php echo $sStyleHidden_imagem_resultado_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_login_moderador_dumb = ('' == $sStyleHidden_login_moderador) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_login_moderador_dumb" style="<?php echo $sStyleHidden_login_moderador_dumb; ?>"></TD>
<?php $sStyleHidden_data_insert_dumb = ('' == $sStyleHidden_data_insert) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_data_insert_dumb" style="<?php echo $sStyleHidden_data_insert_dumb; ?>"></TD>
<?php $sStyleHidden_data_update_dumb = ('' == $sStyleHidden_data_update) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_data_update_dumb" style="<?php echo $sStyleHidden_data_update_dumb; ?>"></TD>
<?php $sStyleHidden_data_resolucao_dumb = ('' == $sStyleHidden_data_resolucao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_data_resolucao_dumb" style="<?php echo $sStyleHidden_data_resolucao_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "Voltar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-3", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "Voltar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-5", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_aravisa_registro_moderador");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_aravisa_registro_moderador");
 parent.scAjaxDetailHeight("form_aravisa_registro_moderador", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
