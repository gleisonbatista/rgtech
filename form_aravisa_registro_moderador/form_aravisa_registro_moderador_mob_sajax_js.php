  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aravisa_registro_moderador_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aravisa_registro_moderador_mob_form();
	}
  ...
  // ---------- Validate pref_usuario_id
  function do_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id()
  {
    var nomeCampo_pref_usuario_id = "pref_usuario_id";
    var var_pref_usuario_id = scAjaxGetFieldSelect(nomeCampo_pref_usuario_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id(var_pref_usuario_id, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id

  function do_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pref_usuario_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_pref_usuario_id_cb

  // ---------- Validate tipo_registro_id
  function do_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id()
  {
    var nomeCampo_tipo_registro_id = "tipo_registro_id";
    var var_tipo_registro_id = scAjaxGetFieldSelect(nomeCampo_tipo_registro_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id(var_tipo_registro_id, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id

  function do_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_registro_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_tipo_registro_id_cb

  // ---------- Validate status
  function do_ajax_form_aravisa_registro_moderador_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldRadio(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_status(var_status, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_status_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_status

  function do_ajax_form_aravisa_registro_moderador_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_status_cb

  // ---------- Validate id
  function do_ajax_form_aravisa_registro_moderador_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_id(var_id, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_id_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_id

  function do_ajax_form_aravisa_registro_moderador_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_id_cb

  // ---------- Validate cep
  function do_ajax_form_aravisa_registro_moderador_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_cep_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_cep

  function do_ajax_form_aravisa_registro_moderador_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_aravisa_registro_moderador_mob_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_endereco_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_endereco

  function do_ajax_form_aravisa_registro_moderador_mob_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_endereco_cb

  // ---------- Validate bairro
  function do_ajax_form_aravisa_registro_moderador_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_bairro_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_bairro

  function do_ajax_form_aravisa_registro_moderador_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_bairro_cb

  // ---------- Validate complemento
  function do_ajax_form_aravisa_registro_moderador_mob_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_complemento_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_complemento

  function do_ajax_form_aravisa_registro_moderador_mob_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_complemento_cb

  // ---------- Validate latitude
  function do_ajax_form_aravisa_registro_moderador_mob_validate_latitude()
  {
    var nomeCampo_latitude = "latitude";
    var var_latitude = scAjaxGetFieldText(nomeCampo_latitude);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_latitude(var_latitude, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_latitude_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_latitude

  function do_ajax_form_aravisa_registro_moderador_mob_validate_latitude_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "latitude";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_latitude_cb

  // ---------- Validate longitude
  function do_ajax_form_aravisa_registro_moderador_mob_validate_longitude()
  {
    var nomeCampo_longitude = "longitude";
    var var_longitude = scAjaxGetFieldText(nomeCampo_longitude);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_longitude(var_longitude, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_longitude_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_longitude

  function do_ajax_form_aravisa_registro_moderador_mob_validate_longitude_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "longitude";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_longitude_cb

  // ---------- Validate imagem
  function do_ajax_form_aravisa_registro_moderador_mob_validate_imagem()
  {
    var nomeCampo_imagem = "imagem";
    var var_imagem = scAjaxGetFieldText(nomeCampo_imagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_imagem(var_imagem, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_imagem

  function do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_cb

  // ---------- Validate imagem_resultado
  function do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado()
  {
    var nomeCampo_imagem_resultado = "imagem_resultado";
    var var_imagem_resultado = scAjaxGetFieldText(nomeCampo_imagem_resultado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado(var_imagem_resultado, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado

  function do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagem_resultado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_imagem_resultado_cb

  // ---------- Validate comentario
  function do_ajax_form_aravisa_registro_moderador_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldHidden(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_comentario_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_comentario

  function do_ajax_form_aravisa_registro_moderador_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_comentario_cb

  // ---------- Validate resposta_moderador
  function do_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador()
  {
    var nomeCampo_resposta_moderador = "resposta_moderador";
    var var_resposta_moderador = scAjaxGetFieldText(nomeCampo_resposta_moderador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador(var_resposta_moderador, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador

  function do_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "resposta_moderador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_resposta_moderador_cb

  // ---------- Validate login_moderador
  function do_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador()
  {
    var nomeCampo_login_moderador = "login_moderador";
    var var_login_moderador = scAjaxGetFieldSelect(nomeCampo_login_moderador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador(var_login_moderador, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador

  function do_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login_moderador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_login_moderador_cb

  // ---------- Validate data_insert
  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_insert()
  {
    var nomeCampo_data_insert = "data_insert";
    var var_data_insert = scAjaxGetFieldHidden(nomeCampo_data_insert);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_data_insert(var_data_insert, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_data_insert_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_insert

  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_insert_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_insert";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_insert_cb

  // ---------- Validate data_update
  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_update()
  {
    var nomeCampo_data_update = "data_update";
    var var_data_update = scAjaxGetFieldHidden(nomeCampo_data_update);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_data_update(var_data_update, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_data_update_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_update

  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_update_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_update";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_update_cb

  // ---------- Validate data_resolucao
  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao()
  {
    var nomeCampo_data_resolucao = "data_resolucao";
    var var_data_resolucao = scAjaxGetFieldHidden(nomeCampo_data_resolucao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao(var_data_resolucao, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao

  function do_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_resolucao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_data_resolucao_cb

  // ---------- Validate valor_pago
  function do_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago()
  {
    var nomeCampo_valor_pago = "valor_pago";
    var var_valor_pago = scAjaxGetFieldText(nomeCampo_valor_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago(var_valor_pago, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago

  function do_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor_pago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_moderador_mob_validate_valor_pago_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_aravisa_registro_moderador_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aravisa_registro_moderador_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pref_usuario_id = scAjaxGetFieldSelect("pref_usuario_id");
    var var_tipo_registro_id = scAjaxGetFieldSelect("tipo_registro_id");
    var var_status = scAjaxGetFieldRadio("status");
    ...
    var var_latitude = scAjaxGetFieldText("latitude");
    var var_longitude = scAjaxGetFieldText("longitude");
    var var_imagem = scAjaxGetFieldText("imagem");
    var var_imagem_resultado = scAjaxGetFieldText("imagem_resultado");
    var var_comentario = scAjaxGetFieldHidden("comentario");
    var var_resposta_moderador = scAjaxGetFieldText("resposta_moderador");
    var var_login_moderador = scAjaxGetFieldSelect("login_moderador");
    var var_data_insert = scAjaxGetFieldHidden("data_insert");
    var var_data_update = scAjaxGetFieldHidden("data_update");
    var var_data_resolucao = scAjaxGetFieldHidden("data_resolucao");
    var var_valor_pago = scAjaxGetFieldText("valor_pago");
    var var_imagem_ul_name = scAjaxSpecCharProtect(document.F1.imagem_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imagem_ul_type = document.F1.imagem_ul_type.value;
    var var_imagem_resultado_ul_name = scAjaxSpecCharProtect(document.F1.imagem_resultado_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imagem_resultado_ul_type = document.F1.imagem_resultado_ul_type.value;
    var var_imagem_salva = scAjaxSpecCharProtect(document.F1.imagem_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imagem_limpa = document.F1.imagem_limpa.checked ? "S" : "N";
    var var_imagem_resultado_salva = scAjaxSpecCharProtect(document.F1.imagem_resultado_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imagem_resultado_limpa = document.F1.imagem_resultado_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_aravisa_registro_moderador_mob_submit_form(var_pref_usuario_id, var_tipo_registro_id, var_status, var_id, var_cep, var_endereco, var_bairro, var_complemento, var_latitude, var_longitude, var_imagem, var_imagem_resultado, var_comentario, var_resposta_moderador, var_login_moderador, var_data_insert, var_data_update, var_data_resolucao, var_valor_pago, var_imagem_ul_name, var_imagem_ul_type, var_imagem_resultado_ul_name, var_imagem_resultado_ul_type, var_imagem_salva, var_imagem_limpa, var_imagem_resultado_salva, var_imagem_resultado_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_submit_form

  function do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pref_usuario_id");
      scAjaxHideErrorDisplay("tipo_registro_id");
      ...
      scAjaxHideErrorDisplay("latitude");
      scAjaxHideErrorDisplay("longitude");
      scAjaxHideErrorDisplay("imagem");
      scAjaxHideErrorDisplay("imagem_resultado");
      scAjaxHideErrorDisplay("comentario");
      scAjaxHideErrorDisplay("resposta_moderador");
      scAjaxHideErrorDisplay("login_moderador");
      scAjaxHideErrorDisplay("data_insert");
      scAjaxHideErrorDisplay("data_update");
      scAjaxHideErrorDisplay("data_resolucao");
      scAjaxHideErrorDisplay("valor_pago");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.imagem_limpa && document.F1.imagem_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("imagem", oImgTemp, "", "", "", "N");
      }
      if (document.F1.imagem_resultado_limpa && document.F1.imagem_resultado_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("imagem_resultado", oImgTemp, "", "", "", "N");
      }
    document.F1.imagem_ul_name.value = '';
    document.F1.imagem_ul_type.value = '';
    document.F1.imagem_resultado_ul_name.value = '';
    document.F1.imagem_resultado_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb
  function do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aravisa_registro_moderador_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aravisa_registro_moderador_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aravisa_registro_moderador_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_aravisa_registro_moderador_mob_navigate_form();
    }
  }

  function perform_ajax_form_aravisa_registro_moderador_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_aravisa_registro_moderador_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb);
  } // do_ajax_form_aravisa_registro_moderador_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_moderador_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb
  function do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aravisa_registro_moderador_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_aravisa_registro_moderador_mob_navigate_form_cb_after_alert
  function sc_hide_form_aravisa_registro_moderador_mob_form()
  {
  ...
  ajax_field_list[0] = "pref_usuario_id";
  ajax_field_list[1] = "tipo_registro_id";
  ajax_field_list[2] = "status";
  ajax_field_list[3] = "id";
  ajax_field_list[4] = "cep";
  ajax_field_list[5] = "endereco";
  ajax_field_list[6] = "bairro";
  ajax_field_list[7] = "complemento";
  ajax_field_list[8] = "latitude";
  ajax_field_list[9] = "longitude";
  ajax_field_list[10] = "imagem";
  ajax_field_list[11] = "imagem_resultado";
  ajax_field_list[12] = "comentario";
  ajax_field_list[13] = "resposta_moderador";
  ajax_field_list[14] = "login_moderador";
  ajax_field_list[15] = "data_insert";
  ajax_field_list[16] = "data_update";
  ajax_field_list[17] = "data_resolucao";
  ajax_field_list[18] = "valor_pago";
  ...
  var ajax_error_list = {
    "pref_usuario_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_pref_usuario_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_registro_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_tipo_registro_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "status": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id": {"label": "Código da Solicitação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cep": {"label": "CEP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "endereco": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_endereco'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bairro": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_bairro'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "complemento": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_complemento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "latitude": {"label": "Latitude", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "longitude": {"label": "Longitude", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imagem": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_imagem'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imagem_resultado": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_imagem_resultado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "comentario": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_comentario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "resposta_moderador": {"label": "Resposta Moderador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login_moderador": {"label": "Moderador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_insert": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_data_insert'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_update": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_data_update'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_resolucao": {"label": "<?php echo $this->Ini->Nm_lang['lang_aravisa_registro_fld_data_resolucao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor_pago": {"label": "Valor à Pagar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pref_usuario_id": new Array(),
    "tipo_registro_id": new Array(),
    "status": new Array(),
    "id": new Array(),
    "cep": new Array(),
    "endereco": new Array(),
    ...
    "longitude": new Array(),
    "imagem": new Array(),
    "imagem_resultado": new Array(),
    "comentario": new Array(),
    "resposta_moderador": new Array(),
    "login_moderador": new Array(),
    "data_insert": new Array(),
    "data_update": new Array(),
    "data_resolucao": new Array(),
    "valor_pago": new Array()
  };
  ajax_field_mult["pref_usuario_id"][1] = "pref_usuario_id";
  ajax_field_mult["tipo_registro_id"][1] = "tipo_registro_id";
  ...
  ajax_field_mult["latitude"][1] = "latitude";
  ajax_field_mult["longitude"][1] = "longitude";
  ajax_field_mult["imagem"][1] = "imagem";
  ajax_field_mult["imagem_resultado"][1] = "imagem_resultado";
  ajax_field_mult["comentario"][1] = "comentario";
  ajax_field_mult["resposta_moderador"][1] = "resposta_moderador";
  ajax_field_mult["login_moderador"][1] = "login_moderador";
  ajax_field_mult["data_insert"][1] = "data_insert";
  ajax_field_mult["data_update"][1] = "data_update";
  ajax_field_mult["data_resolucao"][1] = "data_resolucao";
  ajax_field_mult["valor_pago"][1] = "valor_pago";

  var ajax_field_id = {
    "pref_usuario_id": new Array("hidden_field_label_pref_usuario_id", "hidden_field_data_pref_usuario_id"),
    "tipo_registro_id": new Array("hidden_field_label_tipo_registro_id", "hidden_field_data_tipo_registro_id"),
    ...
    "latitude": new Array("hidden_field_label_latitude", "hidden_field_data_latitude"),
    "longitude": new Array("hidden_field_label_longitude", "hidden_field_data_longitude"),
    "imagem": new Array("hidden_field_label_imagem", "hidden_field_data_imagem"),
    "imagem_resultado": new Array("hidden_field_label_imagem_resultado", "hidden_field_data_imagem_resultado"),
    "comentario": new Array("hidden_field_label_comentario", "hidden_field_data_comentario"),
    "resposta_moderador": new Array("hidden_field_label_resposta_moderador", "hidden_field_data_resposta_moderador"),
    "login_moderador": new Array("hidden_field_label_login_moderador", "hidden_field_data_login_moderador"),
    "data_insert": new Array("hidden_field_label_data_insert", "hidden_field_data_data_insert"),
    "data_update": new Array("hidden_field_label_data_update", "hidden_field_data_data_update"),
    "data_resolucao": new Array("hidden_field_label_data_resolucao", "hidden_field_data_data_resolucao"),
    "valor_pago": new Array("hidden_field_label_valor_pago", "hidden_field_data_valor_pago")
  };

  var ajax_read_only = {
    "pref_usuario_id": "off",
    "tipo_registro_id": "off",
    "status": "off",
    "id": "on",
    "cep": "off",
    "endereco": "off",
    ...
    "longitude": "off",
    "imagem": "off",
    "imagem_resultado": "off",
    "comentario": "off",
    "resposta_moderador": "off",
    "login_moderador": "off",
    "data_insert": "off",
    "data_update": "off",
    "data_resolucao": "off",
