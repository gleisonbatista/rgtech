...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_empresa']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pref_empresa"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_tela_login()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_tela_login(); }, 500);
      return;
    }
    sc_btn_tela_login_ok();
}
function sc_btn_tela_login_cancel()
{
}
function sc_btn_tela_login_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_app_Login_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'app_Login');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_empresa']['where_detal']))
  {
?>  
