  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pref_empresa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pref_empresa_mob_form();
	}
  ...
  // ---------- Validate titulo
  function do_ajax_form_pref_empresa_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_titulo_cb);
  } // do_ajax_form_pref_empresa_mob_validate_titulo

  function do_ajax_form_pref_empresa_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_titulo_cb

  // ---------- Validate razao_social
  function do_ajax_form_pref_empresa_mob_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_razao_social_cb);
  } // do_ajax_form_pref_empresa_mob_validate_razao_social

  function do_ajax_form_pref_empresa_mob_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "razao_social";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_razao_social_cb

  // ---------- Validate nome_fantasia
  function do_ajax_form_pref_empresa_mob_validate_nome_fantasia()
  {
    var nomeCampo_nome_fantasia = "nome_fantasia";
    var var_nome_fantasia = scAjaxGetFieldText(nomeCampo_nome_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_nome_fantasia(var_nome_fantasia, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_nome_fantasia_cb);
  } // do_ajax_form_pref_empresa_mob_validate_nome_fantasia

  function do_ajax_form_pref_empresa_mob_validate_nome_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_fantasia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_nome_fantasia_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_form_pref_empresa_mob_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_cpf_cnpj_cb);
  } // do_ajax_form_pref_empresa_mob_validate_cpf_cnpj

  function do_ajax_form_pref_empresa_mob_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_cpf_cnpj_cb

  // ---------- Validate telefone
  function do_ajax_form_pref_empresa_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_telefone_cb);
  } // do_ajax_form_pref_empresa_mob_validate_telefone

  function do_ajax_form_pref_empresa_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_pref_empresa_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_email(var_email, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_email_cb);
  } // do_ajax_form_pref_empresa_mob_validate_email

  function do_ajax_form_pref_empresa_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_email_cb

  // ---------- Validate priv_admin
  function do_ajax_form_pref_empresa_mob_validate_priv_admin()
  {
    var nomeCampo_priv_admin = "priv_admin";
    var var_priv_admin = scAjaxGetFieldText(nomeCampo_priv_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_priv_admin(var_priv_admin, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_priv_admin_cb);
  } // do_ajax_form_pref_empresa_mob_validate_priv_admin

  function do_ajax_form_pref_empresa_mob_validate_priv_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_priv_admin_cb

  // ---------- Validate login
  function do_ajax_form_pref_empresa_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_login(var_login, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_login_cb);
  } // do_ajax_form_pref_empresa_mob_validate_login

  function do_ajax_form_pref_empresa_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_login_cb

  // ---------- Validate senha
  function do_ajax_form_pref_empresa_mob_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_senha(var_senha, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_senha_cb);
  } // do_ajax_form_pref_empresa_mob_validate_senha

  function do_ajax_form_pref_empresa_mob_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_senha_cb

  // ---------- Validate termo
  function do_ajax_form_pref_empresa_mob_validate_termo()
  {
    var nomeCampo_termo = "termo";
    var var_termo = scAjaxGetFieldCheckbox(nomeCampo_termo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pref_empresa_mob_validate_termo(var_termo, var_script_case_init, do_ajax_form_pref_empresa_mob_validate_termo_cb);
  } // do_ajax_form_pref_empresa_mob_validate_termo

  function do_ajax_form_pref_empresa_mob_validate_termo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "termo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pref_empresa_mob_validate_termo_cb

  // ---------- Event onchange cpf_cnpj
  function do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange()
  {
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange(var_cpf_cnpj, var_script_case_init, do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb);
  } // do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange

  function do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf_cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb
  function do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_empresa_mob_event_cpf_cnpj_onchange_cb_after_alert

  // ---------- Event onchange email
  function do_ajax_form_pref_empresa_mob_event_email_onchange()
  {
    var var_email = scAjaxGetFieldText("email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_empresa_mob_event_email_onchange(var_email, var_script_case_init, do_ajax_form_pref_empresa_mob_event_email_onchange_cb);
  } // do_ajax_form_pref_empresa_mob_event_email_onchange

  function do_ajax_form_pref_empresa_mob_event_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_empresa_mob_event_email_onchange_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_event_email_onchange_cb
  function do_ajax_form_pref_empresa_mob_event_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_empresa_mob_event_email_onchange_cb_after_alert

  // ---------- Event onchange login
  function do_ajax_form_pref_empresa_mob_event_login_onchange()
  {
    var var_login = scAjaxGetFieldText("login");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_empresa_mob_event_login_onchange(var_login, var_script_case_init, do_ajax_form_pref_empresa_mob_event_login_onchange_cb);
  } // do_ajax_form_pref_empresa_mob_event_login_onchange

  function do_ajax_form_pref_empresa_mob_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_empresa_mob_event_login_onchange_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_event_login_onchange_cb
  function do_ajax_form_pref_empresa_mob_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_empresa_mob_event_login_onchange_cb_after_alert

  // ---------- Event onchange telefone
  function do_ajax_form_pref_empresa_mob_event_telefone_onchange()
  {
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pref_empresa_mob_event_telefone_onchange(var_telefone, var_script_case_init, do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb);
  } // do_ajax_form_pref_empresa_mob_event_telefone_onchange

  function do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "telefone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb
  function do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pref_empresa_mob_event_telefone_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pref_empresa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pref_empresa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_titulo = scAjaxGetFieldHidden("titulo");
    var var_razao_social = scAjaxGetFieldText("razao_social");
    var var_nome_fantasia = scAjaxGetFieldText("nome_fantasia");
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_email = scAjaxGetFieldText("email");
    ...
    scAjaxProcOn();
    x_ajax_form_pref_empresa_mob_submit_form(var_titulo, var_razao_social, var_nome_fantasia, var_cpf_cnpj, var_telefone, var_email, var_priv_admin, var_login, var_senha, var_termo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pref_empresa_mob_submit_form_cb);
  } // do_ajax_form_pref_empresa_mob_submit_form

  function do_ajax_form_pref_empresa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("razao_social");
      scAjaxHideErrorDisplay("nome_fantasia");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pref_empresa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_submit_form_cb
  function do_ajax_form_pref_empresa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pref_empresa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pref_empresa_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pref_empresa_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pref_empresa_mob_navigate_form();
    }
  }

  function perform_ajax_form_pref_empresa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pref_empresa_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pref_empresa_mob_navigate_form_cb);
  } // do_ajax_form_pref_empresa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pref_empresa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pref_empresa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pref_empresa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pref_empresa_mob_navigate_form_cb
  function do_ajax_form_pref_empresa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pref_empresa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pref_empresa_mob_navigate_form_cb_after_alert
  function sc_hide_form_pref_empresa_mob_form()
  {
  ...
  ajax_field_list[1] = "razao_social";
  ajax_field_list[2] = "nome_fantasia";
  ajax_field_list[3] = "cpf_cnpj";
  ajax_field_list[4] = "telefone";
  ajax_field_list[5] = "email";
  ajax_field_list[6] = "priv_admin";
  ajax_field_list[7] = "login";
  ajax_field_list[8] = "senha";
  ajax_field_list[9] = "termo";
  ...
  var ajax_error_list = {
    "titulo": {"label": "Cadastro de Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "razao_social": {"label": "Razão Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_fantasia": {"label": "Nome Fantasia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpf_cnpj": {"label": "<?php echo $this->Ini->Nm_lang['lang_pref_usuario_fld_cpf'] ?>/CNPJ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "titulo": new Array(),
    "razao_social": new Array(),
    "nome_fantasia": new Array(),
    "cpf_cnpj": new Array(),
    "telefone": new Array(),
    "email": new Array(),
  ...
  ajax_field_mult["razao_social"][1] = "razao_social";
  ajax_field_mult["nome_fantasia"][1] = "nome_fantasia";
  ...
  var ajax_field_id = {
    ...
    "razao_social": new Array("hidden_field_label_razao_social", "hidden_field_data_razao_social"),
    "nome_fantasia": new Array("hidden_field_label_nome_fantasia", "hidden_field_data_nome_fantasia"),
