...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_data_insert_hora' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_update_user_data_insert_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_aravisa_registro_update_user_data_insert_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_data_update_hora' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_update_user_data_update_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_aravisa_registro_update_user_data_update_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_aravisa_registro_update_user_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_insert" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_update" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_update_user_mob_validate_data_update(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_resolucao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_update_user_mob_validate_data_resolucao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imagem" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_aravisa_registro_update_user_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_aravisa_registro_update_user_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
