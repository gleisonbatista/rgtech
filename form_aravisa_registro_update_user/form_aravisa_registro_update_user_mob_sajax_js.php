  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aravisa_registro_update_user_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aravisa_registro_update_user_mob_form();
	}
  ...
  function do_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id()
  {
    ...
    x_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id(var_tipo_registro_id, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id

  function do_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_tipo_registro_id_cb

  // ---------- Validate id
  function do_ajax_form_aravisa_registro_update_user_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_id(var_id, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_id_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_id

  function do_ajax_form_aravisa_registro_update_user_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_id_cb

  // ---------- Validate cep
  function do_ajax_form_aravisa_registro_update_user_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_cep_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_cep

  function do_ajax_form_aravisa_registro_update_user_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_aravisa_registro_update_user_mob_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_endereco_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_endereco

  function do_ajax_form_aravisa_registro_update_user_mob_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_endereco_cb

  // ---------- Validate bairro
  function do_ajax_form_aravisa_registro_update_user_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_bairro_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_bairro

  function do_ajax_form_aravisa_registro_update_user_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_bairro_cb

  // ---------- Validate complemento
  function do_ajax_form_aravisa_registro_update_user_mob_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_complemento_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_complemento

  function do_ajax_form_aravisa_registro_update_user_mob_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_complemento_cb

  // ---------- Validate latitude
  function do_ajax_form_aravisa_registro_update_user_mob_validate_latitude()
  {
    var nomeCampo_latitude = "latitude";
    var var_latitude = scAjaxGetFieldText(nomeCampo_latitude);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_latitude(var_latitude, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_latitude_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_latitude

  function do_ajax_form_aravisa_registro_update_user_mob_validate_latitude_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_latitude_cb

  // ---------- Validate longitude
  function do_ajax_form_aravisa_registro_update_user_mob_validate_longitude()
  {
    var nomeCampo_longitude = "longitude";
    var var_longitude = scAjaxGetFieldText(nomeCampo_longitude);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_longitude(var_longitude, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_longitude_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_longitude

  function do_ajax_form_aravisa_registro_update_user_mob_validate_longitude_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_longitude_cb

  // ---------- Validate imagem
  function do_ajax_form_aravisa_registro_update_user_mob_validate_imagem()
  {
    var nomeCampo_imagem = "imagem";
    var var_imagem = scAjaxGetFieldText(nomeCampo_imagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_imagem(var_imagem, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_imagem_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_imagem

  function do_ajax_form_aravisa_registro_update_user_mob_validate_imagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_imagem_cb

  // ---------- Validate comentario
  function do_ajax_form_aravisa_registro_update_user_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_comentario_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_comentario

  function do_ajax_form_aravisa_registro_update_user_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_comentario_cb

  // ---------- Validate pref_usuario_id
  function do_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id()
  {
    var nomeCampo_pref_usuario_id = "pref_usuario_id";
    var var_pref_usuario_id = scAjaxGetFieldSelect(nomeCampo_pref_usuario_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id(var_pref_usuario_id, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id

  function do_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_pref_usuario_id_cb

  // ---------- Validate data_insert
  function do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert()
  {
    var nomeCampo_data_insert = "data_insert";
    var var_data_insert = scAjaxGetFieldHidden(nomeCampo_data_insert);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_data_insert(var_data_insert, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert

  function do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_data_insert_cb

  // ---------- Validate data_update
  function do_ajax_form_aravisa_registro_update_user_mob_validate_data_update()
  {
    var nomeCampo_data_update = "data_update";
    var var_data_update = scAjaxGetFieldHidden(nomeCampo_data_update);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aravisa_registro_update_user_mob_validate_data_update(var_data_update, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_validate_data_update_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_data_update

  function do_ajax_form_aravisa_registro_update_user_mob_validate_data_update_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aravisa_registro_update_user_mob_validate_data_update_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_aravisa_registro_update_user_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aravisa_registro_update_user_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_aravisa_registro_update_user_mob_submit_form(var_tipo_registro_id, var_id, var_cep, var_endereco, var_bairro, var_complemento, var_latitude, var_longitude, var_imagem, var_comentario, var_pref_usuario_id, var_data_insert, var_data_update, var_imagem_ul_name, var_imagem_ul_type, var_imagem_salva, var_imagem_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_submit_form

  function do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb
  function do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aravisa_registro_update_user_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aravisa_registro_update_user_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aravisa_registro_update_user_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_aravisa_registro_update_user_mob_navigate_form();
    }
  }

  function perform_ajax_form_aravisa_registro_update_user_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_aravisa_registro_update_user_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb);
  } // do_ajax_form_aravisa_registro_update_user_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aravisa_registro_update_user_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb
  function do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_aravisa_registro_update_user_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_aravisa_registro_update_user_mob_navigate_form_cb_after_alert
  function sc_hide_form_aravisa_registro_update_user_mob_form()
  {
  ...
  ajax_field_list[0] = "tipo_registro_id";
  ajax_field_list[1] = "id";
  ajax_field_list[2] = "cep";
  ajax_field_list[3] = "endereco";
  ajax_field_list[4] = "bairro";
  ajax_field_list[5] = "complemento";
  ajax_field_list[6] = "latitude";
  ajax_field_list[7] = "longitude";
  ajax_field_list[8] = "imagem";
  ajax_field_list[9] = "comentario";
  ajax_field_list[10] = "pref_usuario_id";
  ajax_field_list[11] = "data_insert";
  ajax_field_list[12] = "data_update";
