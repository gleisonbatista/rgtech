...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_aravisa_registro_id_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_form_aravisa_registro_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_pref_usuario_id' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_pref_usuario_id_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_aravisa_registro_pref_usuario_id_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_aravisa_registro_pref_usuario_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagem' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_imagem_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_aravisa_registro_imagem_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_aravisa_registro_imagem_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_registro_id' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_tipo_registro_id_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_aravisa_registro_tipo_registro_id_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_aravisa_registro_tipo_registro_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_cep' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_cep_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_aravisa_registro_cep_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_aravisa_registro_cep_onfocus(this, iSeqRow) });
  $('#id_sc_field_endereco' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_endereco_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_aravisa_registro_endereco_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_aravisa_registro_endereco_onfocus(this, iSeqRow) });
  $('#id_sc_field_bairro' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_bairro_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_aravisa_registro_bairro_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_aravisa_registro_bairro_onfocus(this, iSeqRow) });
  $('#id_sc_field_complemento' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_complemento_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_aravisa_registro_complemento_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_aravisa_registro_complemento_onfocus(this, iSeqRow) });
  $('#id_sc_field_latitude' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_latitude_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_aravisa_registro_latitude_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_aravisa_registro_latitude_onfocus(this, iSeqRow) });
  $('#id_sc_field_longitude' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_longitude_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_aravisa_registro_longitude_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_aravisa_registro_longitude_onfocus(this, iSeqRow) });
  $('#id_sc_field_comentario' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_comentario_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_aravisa_registro_comentario_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_aravisa_registro_comentario_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_status_onchange(this, iSeqRow) });
  $('#id_sc_field_imagem_resultado' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_imagem_resultado_onchange(this, iSeqRow) });
  $('#id_sc_field_login_moderador' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_login_moderador_onchange(this, iSeqRow) });
  $('#id_sc_field_data_resolucao' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_data_resolucao_onchange(this, iSeqRow) });
  $('#id_sc_field_data_insert' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_data_insert_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_aravisa_registro_data_insert_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_aravisa_registro_data_insert_onfocus(this, iSeqRow) });
  $('#id_sc_field_data_insert_hora' + iSeqRow).bind('blur', function() { sc_form_aravisa_registro_data_insert_hora_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_aravisa_registro_data_insert_hora_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_aravisa_registro_data_insert_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_data_update' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_data_update_onchange(this, iSeqRow) });
  $('#id_sc_field_data_update_hora' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_data_update_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_resposta_moderador' + iSeqRow).bind('change', function() { sc_form_aravisa_registro_resposta_moderador_onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_aravisa_registro_id_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_id();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_pref_usuario_id_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_pref_usuario_id();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_pref_usuario_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_pref_usuario_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_imagem_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_imagem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_imagem_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_tipo_registro_id_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_tipo_registro_id();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_tipo_registro_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_tipo_registro_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_cep_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_cep();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_cep_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  cep_cep(oThis.value, 'F1;CEP,cep;BAIRRO,bairro;RUA,endereco');
}

function sc_form_aravisa_registro_cep_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_endereco_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_endereco();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_endereco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_endereco_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_bairro_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_bairro();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_bairro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_bairro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_complemento_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_complemento();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_complemento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_complemento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_latitude_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_latitude();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_latitude_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_latitude_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_longitude_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_longitude();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_longitude_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_longitude_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_comentario_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_comentario();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_comentario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_comentario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_imagem_resultado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_login_moderador_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_data_resolucao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_data_insert_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_data_insert();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_data_insert_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_aravisa_registro_validate_data_insert();
  scCssBlur(oThis);
}

function sc_form_aravisa_registro_data_insert_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_data_insert_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_data_insert_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_data_insert_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_aravisa_registro_data_update_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_data_update_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_aravisa_registro_resposta_moderador_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_aravisa_registro_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_insert" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_validate_data_insert(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_resolucao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_validate_data_resolucao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_update" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_aravisa_registro_validate_data_update(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imagem" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_aravisa_registro_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_aravisa_registro')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
