  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aracash_pagamento_empresa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aracash_pagamento_empresa_mob_form();
	}
  ...
  // ---------- Validate cpf
  function do_ajax_form_aracash_pagamento_empresa_mob_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_mob_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_validate_cpf_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_cpf

  function do_ajax_form_aracash_pagamento_empresa_mob_validate_cpf_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_cpf_cb

  // ---------- Validate valor_pago
  function do_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago()
  {
    var nomeCampo_valor_pago = "valor_pago";
    var var_valor_pago = scAjaxGetFieldText(nomeCampo_valor_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago(var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago

  function do_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_valor_pago_cb

  // ---------- Validate nome_cliente
  function do_ajax_form_aracash_pagamento_empresa_mob_validate_nome_cliente()
  {
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_nome_cliente

  function do_ajax_form_aracash_pagamento_empresa_mob_validate_nome_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_nome_cliente_cb

  // ---------- Validate empresa_id
  function do_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id()
  {
    var nomeCampo_empresa_id = "empresa_id";
    var var_empresa_id = scAjaxGetFieldSelect(nomeCampo_empresa_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id(var_empresa_id, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id

  function do_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_empresa_id_cb

  // ---------- Validate usuario_id
  function do_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id()
  {
    var nomeCampo_usuario_id = "usuario_id";
    var var_usuario_id = scAjaxGetFieldText(nomeCampo_usuario_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id(var_usuario_id, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id

  function do_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_mob_validate_usuario_id_cb

  // ---------- Event onchange cpf
  function do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange()
  {
    var var_cpf = scAjaxGetFieldText("cpf");
    var var_usuario_id = scAjaxGetFieldText("usuario_id");
    var var_nome_cliente = scAjaxGetFieldHidden("nome_cliente");
    var var_valor_pago = scAjaxGetFieldText("valor_pago");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange(var_cpf, var_usuario_id, var_nome_cliente, var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange

  function do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb
  function do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_cpf_onchange_cb_after_alert

  // ---------- Event onchange valor_pago
  function do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange()
  {
    var var_usuario_id = scAjaxGetFieldText("usuario_id");
    var var_valor_pago = scAjaxGetFieldText("valor_pago");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange(var_usuario_id, var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange

  function do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "valor_pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb
  function do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aracash_pagamento_empresa_mob_event_valor_pago_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_aracash_pagamento_empresa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aracash_pagamento_empresa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cpf = scAjaxGetFieldText("cpf");
    var var_valor_pago = scAjaxGetFieldText("valor_pago");
    var var_nome_cliente = scAjaxGetFieldHidden("nome_cliente");
    var var_empresa_id = scAjaxGetFieldSelect("empresa_id");
    var var_usuario_id = scAjaxGetFieldText("usuario_id");
    ...
    scAjaxProcOn();
    x_ajax_form_aracash_pagamento_empresa_mob_submit_form(var_cpf, var_valor_pago, var_nome_cliente, var_empresa_id, var_usuario_id, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_submit_form

  function do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nome_cliente");
      scAjaxHideErrorDisplay("empresa_id");
      scAjaxHideErrorDisplay("usuario_id");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb
  function do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aracash_pagamento_empresa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aracash_pagamento_empresa_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aracash_pagamento_empresa_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_aracash_pagamento_empresa_mob_navigate_form();
    }
  }

  function perform_ajax_form_aracash_pagamento_empresa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aracash_pagamento_empresa_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb);
  } // do_ajax_form_aracash_pagamento_empresa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aracash_pagamento_empresa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb
  function do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('cpf');
...
{
?>
    do_ajax_form_aracash_pagamento_empresa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_aracash_pagamento_empresa_mob_navigate_form_cb_after_alert
  function sc_hide_form_aracash_pagamento_empresa_mob_form()
  {
  ...
  ajax_field_list[0] = "cpf";
  ajax_field_list[1] = "valor_pago";
  ajax_field_list[2] = "nome_cliente";
  ajax_field_list[3] = "empresa_id";
  ajax_field_list[4] = "usuario_id";
  ...
  var ajax_error_list = {
    "cpf": {"label": "CPF do Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor_pago": {"label": "Valor a Receber", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_cliente": {"label": "Nome do Pagador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "empresa_id": {"label": "Entidade recebedora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_id": {"label": "Pagador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "empresa_id": new Array(),
    "usuario_id": new Array()
  };
  ajax_field_mult["cpf"][1] = "cpf";
  ajax_field_mult["valor_pago"][1] = "valor_pago";
  ajax_field_mult["nome_cliente"][1] = "nome_cliente";
  ajax_field_mult["empresa_id"][1] = "empresa_id";
  ajax_field_mult["usuario_id"][1] = "usuario_id";
  ...
  var ajax_field_id = {
    ...
    "nome_cliente": new Array("hidden_field_label_nome_cliente", "hidden_field_data_nome_cliente"),
    "empresa_id": new Array("hidden_field_label_empresa_id", "hidden_field_data_empresa_id")
  };
