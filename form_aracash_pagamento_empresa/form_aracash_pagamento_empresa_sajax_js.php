  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aracash_pagamento_empresa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aracash_pagamento_empresa_form();
	}
  ...
  // ---------- Validate cpf
  function do_ajax_form_aracash_pagamento_empresa_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_validate_cpf_cb);
  } // do_ajax_form_aracash_pagamento_empresa_validate_cpf

  function do_ajax_form_aracash_pagamento_empresa_validate_cpf_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_validate_cpf_cb

  // ---------- Validate valor_pago
  function do_ajax_form_aracash_pagamento_empresa_validate_valor_pago()
  {
    var nomeCampo_valor_pago = "valor_pago";
    var var_valor_pago = scAjaxGetFieldText(nomeCampo_valor_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_validate_valor_pago(var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_validate_valor_pago_cb);
  } // do_ajax_form_aracash_pagamento_empresa_validate_valor_pago

  function do_ajax_form_aracash_pagamento_empresa_validate_valor_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_validate_valor_pago_cb

  // ---------- Validate nome_cliente
  function do_ajax_form_aracash_pagamento_empresa_validate_nome_cliente()
  {
  } // do_ajax_form_aracash_pagamento_empresa_validate_nome_cliente

  function do_ajax_form_aracash_pagamento_empresa_validate_nome_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_validate_nome_cliente_cb

  // ---------- Validate empresa_id
  function do_ajax_form_aracash_pagamento_empresa_validate_empresa_id()
  {
    var nomeCampo_empresa_id = "empresa_id";
    var var_empresa_id = scAjaxGetFieldSelect(nomeCampo_empresa_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_validate_empresa_id(var_empresa_id, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_validate_empresa_id_cb);
  } // do_ajax_form_aracash_pagamento_empresa_validate_empresa_id

  function do_ajax_form_aracash_pagamento_empresa_validate_empresa_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_validate_empresa_id_cb

  // ---------- Validate usuario_id
  function do_ajax_form_aracash_pagamento_empresa_validate_usuario_id()
  {
    var nomeCampo_usuario_id = "usuario_id";
    var var_usuario_id = scAjaxGetFieldText(nomeCampo_usuario_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aracash_pagamento_empresa_validate_usuario_id(var_usuario_id, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_validate_usuario_id_cb);
  } // do_ajax_form_aracash_pagamento_empresa_validate_usuario_id

  function do_ajax_form_aracash_pagamento_empresa_validate_usuario_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aracash_pagamento_empresa_validate_usuario_id_cb

  // ---------- Event onchange cpf
  function do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_aracash_pagamento_empresa_event_cpf_onchange(var_cpf, var_usuario_id, var_nome_cliente, var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb);
  } // do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange

  function do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb
  function do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aracash_pagamento_empresa_event_cpf_onchange_cb_after_alert

  // ---------- Event onchange valor_pago
  function do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange()
  {
    var var_usuario_id = scAjaxGetFieldText("usuario_id");
    var var_valor_pago = scAjaxGetFieldText("valor_pago");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange(var_usuario_id, var_valor_pago, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb);
  } // do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange

  function do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "valor_pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb
  function do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_aracash_pagamento_empresa_event_valor_pago_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_aracash_pagamento_empresa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aracash_pagamento_empresa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cpf = scAjaxGetFieldText("cpf");
    ...
    scAjaxProcOn();
    x_ajax_form_aracash_pagamento_empresa_submit_form(var_cpf, var_valor_pago, var_nome_cliente, var_empresa_id, var_usuario_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aracash_pagamento_empresa_submit_form_cb);
  } // do_ajax_form_aracash_pagamento_empresa_submit_form

  function do_ajax_form_aracash_pagamento_empresa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_submit_form_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_submit_form_cb
  function do_ajax_form_aracash_pagamento_empresa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aracash_pagamento_empresa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aracash_pagamento_empresa_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_aracash_pagamento_empresa_navigate_form, function() {});
    } else {
      perform_ajax_form_aracash_pagamento_empresa_navigate_form();
    }
  }

  function perform_ajax_form_aracash_pagamento_empresa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aracash_pagamento_empresa_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aracash_pagamento_empresa_navigate_form_cb);
  } // do_ajax_form_aracash_pagamento_empresa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aracash_pagamento_empresa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aracash_pagamento_empresa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aracash_pagamento_empresa_navigate_form_cb_after_alert);
  } // do_ajax_form_aracash_pagamento_empresa_navigate_form_cb
  function do_ajax_form_aracash_pagamento_empresa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('cpf');
...
{
?>
    do_ajax_form_aracash_pagamento_empresa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aracash_pagamento_empresa_navigate_form_cb_after_alert
  function sc_hide_form_aracash_pagamento_empresa_form()
  {
