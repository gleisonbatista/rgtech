...
<?php
   ...
   $Ord_Cmp = new app_grid_sec_users_groups_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class app_grid_sec_users_groups_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"] : "" . $this->Nm_lang['lang_pref_usuario_fld_login'] . "";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["nome"] : "" . $this->Nm_lang['lang_pref_usuario_fld_nome'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"] : "" . $this->Nm_lang['lang_pref_usuario_fld_email'] . "";
   $tab_ger_campos['ativo'] = "on";
   $tab_def_campos['ativo'] = "ativo";
   $tab_labels["ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["ativo"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["ativo"] : "" . $this->Nm_lang['lang_pref_usuario_fld_ativo'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "app_grid_sec_users_groups_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
