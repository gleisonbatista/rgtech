...
<?php
   ...
   $Ord_Cmp = new grid_aravisa_registro_usuario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aravisa_registro_usuario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["id"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_id'] . "";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["status"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_status'] . "";
   $tab_ger_campos['tipo_registro_id'] = "on";
   $tab_def_campos['tipo_registro_id'] = "tipo_registro_id";
   $tab_labels["tipo_registro_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["tipo_registro_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["tipo_registro_id"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_tipo_registro_id'] . "";
   $tab_ger_campos['endereco'] = "on";
   $tab_def_campos['endereco'] = "endereco";
   $tab_labels["endereco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["endereco"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["endereco"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_endereco'] . "";
   $tab_ger_campos['bairro'] = "on";
   $tab_def_campos['bairro'] = "bairro";
   $tab_labels["bairro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["bairro"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["bairro"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_bairro'] . "";
   $tab_ger_campos['data_insert'] = "on";
   $tab_def_campos['data_insert'] = "data_insert";
   $tab_labels["data_insert"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_insert"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_insert"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_data_insert'] . "";
   $tab_ger_campos['data_update'] = "on";
   $tab_def_campos['data_update'] = "data_update";
   $tab_labels["data_update"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_update"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_update"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_data_update'] . "";
   $tab_ger_campos['data_resolucao'] = "on";
   $tab_def_campos['data_resolucao'] = "data_resolucao";
   $tab_labels["data_resolucao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_resolucao"])) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['labels']["data_resolucao"] : "" . $this->Nm_lang['lang_aravisa_registro_fld_data_resolucao'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aravisa_registro_usuario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_aravisa_registro_usuario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
